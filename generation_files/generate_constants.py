...
def construct_value(value):
    ...
    if type_ == "Transform2D":
        return (
            f"helpers.ConstantTransform2D.new4(Vector2.new3({values[0]}, {values[1]}), "
    ...
    if type_ == "Basis":
        return (
            f"helpers.ConstantBasis.new4(Vector3.new3({values[0]}, {values[1]}, {values[2]}), "
            f"Vector3.new3({values[3]}, {values[4]}, {values[5]}), "
            f"Vector3.new3({values[6]}, {values[7]}, {values[8]}),)"
        )
    if type_ == "Transform3D":
        return (
            f"helpers.ConstantTransform3D.new3(Vector3.new3({values[0]}, {values[1]}, {values[2]}), "
            f"Vector3.new3({values[3]}, {values[4]}, {values[5]}), "
            f"Vector3.new3({values[6]}, {values[7]}, {values[8]}),"
    ...
    if type_ == "Projection":
        return (
            f"helpers.ConstantProjection.new3(Vector4.new3({values[0]}, {values[1]}, {values[2]},{values[3]}), "
