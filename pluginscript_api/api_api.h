...
static void (*__pyx_api_f_16pluginscript_api_3api_call_method_pluginscript_instance)(godot_pluginscript_instance_data *, godot_string_name const *, godot_variant const **, int, godot_variant_call_error *) = 0;
...
static int import_pluginscript_api__api(void) {
  ...
  if (__Pyx_ImportFunction(module, "call_method_pluginscript_instance", (void (**)(void))&__pyx_api_f_16pluginscript_api_3api_call_method_pluginscript_instance, "void (godot_pluginscript_instance_data *, godot_string_name const *, godot_variant const **, int, godot_variant_call_error *)") < 0) goto bad;
