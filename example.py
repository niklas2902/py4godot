...
def clear_build():
    shutil.rmtree(os.path.dirname(f"addons/windows64/"), onerror=onerror)
...
if __name__ == "__main__":
    ...
    my_parser.add_argument(
        "-download_godot", help="should tests be run", default="False"
    )
    my_parser.add_argument(
    ...
    try:
        res = subprocess.Popen(
            f"python build.py --target_platform={args.target_platform} "
    ...
    create_gdextension()
    shutil.copy(
        "build_resources/dependencies.txt", "example/addons/py4godot/dependencies.txt"
    )
    shutil.copy(
    ...
    shutil.copy(
        "build_resources/signal_script.py", "example/addons/py4godot/signal_script.py"
    )
