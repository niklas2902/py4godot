...
class PythonTest(unittest.TestCase):
    ...
    def test_custom_signal_no_args(self):
        ...
        self.test_object.custom_signal_no_args.emit()
        self.assertTrue(
            self.test_object.custom_signal_no_arg_called)  # Did not toggle
    ...
    def test_custom_signal_with_args(self):
        ...
        try:
            ...
            pass
        self.assertEqual(
            self.test_object.custom_signal_with_args_value,
            5)  # Did not change
    ...
    def test_lambdas(self):
        self.test_object.custom_signal_godot_object.connect(
            lambda val: self.assertEqual(val, 5))
        l = [False]

        def set_visibility(val):
            l[0] = True

        def x(): return set_visibility(True)
        ...
        def x2(val): return self.assertEqual(val, 5)
