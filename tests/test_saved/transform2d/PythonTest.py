...
class PythonTest(unittest.TestCase):
    def test_new_with_axis_origin(self):
        transform = Transform2D.new_with_axis_origin(
    ...
    def test_get_origin(self):
        transform = Transform2D.new_with_axis_origin(
            Vector2(1, 0), Vector2(0, 1), Vector2(1, 2)
        )
        self.assertEqual(transform.get_origin(), Vector2(1, 2))

    def test_get_scale(self):
        transform = Transform2D.new_with_axis_origin(
            Vector2(2, 0), Vector2(0, 1), Vector2(1, 2)
        )
    ...
    def test_scaled(self):
        transform = Transform2D.new_with_axis_origin(
            Vector2(2, 0), Vector2(0, 4), Vector2(3, 5)
        )

        self.assertEqual(
            transform.scaled(Vector2(2, 3)),
            Transform2D.new_with_axis_origin(
                Vector2(4, 0), Vector2(0, 12), Vector2(6, 15)
            ),
        )
