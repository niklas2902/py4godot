...
class PythonTest(unittest.TestCase):
    ...
    def test_normalized(self):
        quat = Quat(1, 2, 3, 4)
        self.assertEqual(str(quat.normalized()),
    ...
    def test_cubic_slerp(self):
        quat = Quat(1, 0, 0, 0)
        self.assertEqual(str(quat.cubic_slerp(Quat(1, 0, 0, 0), Quat(0, 1, 0, 0), Quat(
            0, 0, 1, 0), 1.5707963)), "-0.947706, 0.249319, -0.199231, -0")
