...
class PythonTest(unittest.TestCase):
    ...
    def test_intersects(self):
        ...
        self.assertEqual(Rect2(0, 0, 2, 2).intersects(
            Rect2(-1, -1, 2, 2)), True)
        self.assertEqual(
            Rect2(
                2,
    ...
    def test_encloses(self):
        ...
        self.assertEqual(
            Rect2(-1, -1, 2, 2).encloses(Rect2(-1, -1, 2, 2)), True)
    ...
    def test_grow(self):
        for i in range(1, 10):
            self.assertEqual(Rect2(0, 0, 2, 2).grow(
                i), Rect2(-i, -i, 2 + 2 * i, 2 + 2 * i))
        ...
        self.assertEqual(
            Rect2(
                ...
                Vector2(
                    2, 1)), Rect2(
                    0, 0, 2, 1))
        self.assertEqual(Rect2(0, 0, 1, 1).expand(
            Vector2(-1, 1)), Rect2(-1, 0, 2, 1))
        self.assertEqual(
            Rect2(
                0, 0, 1, 1).expand(
                Vector2(
