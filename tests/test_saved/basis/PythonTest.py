...
class PythonTest(unittest.TestCase):
        ...
        self.assertEqual(
            Basis.new_with_rows(
                Vector3(
                    2, 0, 0), Vector3(
                    0, 1, 0), Vector3(
                    0, 0, 1)).inverse(), Basis.new_with_rows(
                        Vector3(
                            0.5, 0, 0), Vector3(
                                0, 1, 0), Vector3(
                                    0, 0, 1)))
        ...
        self.assertEqual(
            Basis.new_with_rows(
                Vector3(
                    1, 2, 3), Vector3(
                    1, 2, 3), Vector3(
                    1, 2, 3)).transposed(), Basis.new_with_rows(
                        Vector3(
                            1, 1, 1), Vector3(
                                2, 2, 2), Vector3(
                                    3, 3, 3)))
    ...
    def test_rotated(self):
        self.assertEqual(
            Basis().rotated(
                Vector3(
                    1, 0, 0), 1.570796327), Basis.new_with_axis_and_angle(
                Vector3(
                    1, 0, 0), 1.570796327))
        ...
        self.assertEqual(
            Basis.new_with_rows(
                Vector3(
                    1, 0, 0), Vector3(
                    0, 2, 0), Vector3(
                    0, 0, 3)).get_axis(2), Vector3(
                        0, 0, 3))

    def test_set_axis(self):
        basis = Basis.new_with_rows(
            Vector3(
                1, 0, 0), Vector3(
                0, 2, 0), Vector3(
                0, 0, 3))
