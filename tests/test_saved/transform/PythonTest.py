...
class PythonTest(unittest.TestCase):
        ...
        transform.set_basis(
            Basis.new_with_rows(
                Vector3(
                    ...
                    0, 0, 3)))
        self.assertEqual(
            transform.get_basis(), Basis.new_with_rows(
                Vector3(
                    3, 0, 0), Vector3(
                    0, 3, 0), Vector3(
                    0, 0, 3)))
    ...
    def test_inverse(self):
        ...
        self.assertEqual(transform, Transform.new_with_axis_origin(
    ...
    def test_xform_plane(self):
        ...
        self.assertEqual(
            str(transform),
            "0.267261, 0.534522, 0.801784, 18.708286")
    ...
    def test_xform_inv_plane(self):
        ...
        self.assertEqual(
            str(transform),
            "0.267261, 0.534522, 0.801784, 11.224972")
        ...
        self.assertEqual(
            ...
            Transform.new_with_axis_origin(
                ...
                Vector3(
                    ...
                    6)))
        self.assertEqual(
            transform.mult(transform2), Transform.new_with_axis_origin(
                Vector3(
                    2, 0, 0), Vector3(
                    0, 3, 0), Vector3(
                    0, 0, 4), Vector3(
