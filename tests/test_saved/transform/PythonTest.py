...
class PythonTest(unittest.TestCase):
    ...
    def test_new_with_axis_origin(self):
        transform = Transform.new_with_axis_origin(
    ...
    def test_set_basis(self):
        ...
        transform.set_basis(
            Basis.new_with_rows(Vector3(3, 0, 0), Vector3(0, 3, 0), Vector3(0, 0, 3))
        )
        self.assertEqual(
            transform.get_basis(),
            Basis.new_with_rows(Vector3(3, 0, 0), Vector3(0, 3, 0), Vector3(0, 0, 3)),
    ...
    def test_inverse(self):
        transform = Transform.new_with_axis_origin(
            Vector3(1, 0, 0), Vector3(0, 1, 0), Vector3(0, 0, 1), Vector3(1, 2, 3)
        )
        transform = transform.inverse()
        self.assertEqual(
            transform,
            Transform.new_with_axis_origin(
                Vector3(1, 0, 0),
                Vector3(0, 1, 0),
                Vector3(0, 0, 1),
                Vector3(-1, -2, -3),
    ...
    def test_scaled(self):
        ...
        self.assertEqual(
            transform,
            Transform.new_with_axis_origin(
                Vector3(2, 0, 0), Vector3(0, 3, 0), Vector3(0, 0, 4), Vector3(2, 6, 12)
            ),
        )
    ...
    def test_looking_at(self):
        ...
        self.assertEqual(
            str(transform),
            "0.447214, 0, -0.894427, -0.894427, 0, -0.447214, 0, 1, 0 - 1, 2, 3",
        )
    ...
    def test_xform_aabb(self):
        ...
        transform = transform.xform_aabb(
            AABB(
                Vector3(
                    1,
                    1,
    ...
    def test_xform_inv_aabb(self):
        ...
        transform = transform.xform_inv_aabb(
            AABB(
                Vector3(
                    1,
                    1,
    ...
    def test_mult(self):
        ...
        transform2 = Transform.new_with_axis_origin(
            Vector3(2, 0, 0), Vector3(0, 3, 0), Vector3(0, 0, 4), Vector3(1, 2, 3)
        )
        self.assertEqual(
            transform * transform2,
            Transform.new_with_axis_origin(
                Vector3(2, 0, 0), Vector3(0, 3, 0), Vector3(0, 0, 4), Vector3(2, 4, 6)
            ),
        )
        self.assertEqual(
            transform.mult(transform2),
            Transform.new_with_axis_origin(
                Vector3(2, 0, 0), Vector3(0, 3, 0), Vector3(0, 0, 4), Vector3(2, 4, 6)
            ),
        )
