...
class PythonTest(unittest.TestCase):
    ...
    def test_distance_squared_to(self):
        self.assertEqual(
            Vector3(
                1, 0, 0).distance_squared_to(
                Vector3(
                    0, 0, 0)), 1)
        self.assertEqual(
            Vector3(
                2, 0, 0).distance_squared_to(
                Vector3(
                    0, 0, 0)), 4)
        self.assertEqual(
            Vector3(
                3, 1, 0).distance_squared_to(
                Vector3(
                    0, 1, 0)), 9)
        self.assertEqual(
            Vector3(
                1, 1, 1).distance_squared_to(
                Vector3(
                    0, 0, 0)), 3)
    ...
    def test_rotated(self):
        self.assertEqual(
            Vector3(
                1, 0, 0).rotated(
                Vector3(
                    0, 1, 0), 3.14159265359).get_axis(
                    Vector3_Axis.X.value), -1)
        self.assertEqual(
            Vector3(
                1,
                0,
                ...
                Vector3(
                    ...
                    0),
                0).get_axis(
                Vector3_Axis.X.value),
            1)
        self.assertEqual(int(Vector3(1, 0, 0).rotated(
            Vector3(0, 1, 0), 1.57079632679).get_axis(Vector3_Axis.X.value)), 0)
        ...
        self.assertEqual(
            Vector3(
                ...
                Vector3(
                    0, 1, 0)), Vector3(
                    0, 0, 1))
        self.assertEqual(Vector3(1, 2, 3).cross(
            Vector3(3, 2, 1)), Vector3(-4, 8, -4))
        self.assertEqual(
            Vector3(
                0, 0, 0).cross(
                Vector3(
        ...
        self.assertEqual(
            Vector3(
                ...
                Vector3(
                    0, 1, 0)), Vector3(
                    3, -2, 1))
        self.assertEqual(Vector3(1, 2, 1).bounce(
            Vector3(1, 0, 0)), Vector3(-1, 2, 1))

    def test_reflect(self):
        print(Vector3(1, 2, 1).reflect(Vector3(0, 0, 1)))
        self.assertEqual(Vector3(1, 2, 1).reflect(
            Vector3(0, 0, 1)), Vector3(-1, -2, 1))
        self.assertEqual(
            Vector3(
                1, 2, 3).reflect(
                Vector3(
                    1, 0, 0)), Vector3(
                    1, -2, -3))
        self.assertEqual(Vector3(1, 2, 3).reflect(
            Vector3(0, 1, 0)), Vector3(-1, 2, -3))
    ...
    def test_sub_operator(self):
        ...
        self.assertEqual(Vector3(1, 2, 3) -
                         (Vector3(0, 0, 1)), Vector3(1, 2, 2))
    ...
    def test_multiplay_vector(self):
        self.assertEqual(
            Vector3(
                1, 2, 3).multiply_vector(
                Vector3(
                    1, 2, 3)), Vector3(
                    1, 4, 9))
        self.assertEqual(
            Vector3(-1, 2, 5).multiply_vector(Vector3(1, 2, 3)), Vector3(-1, 4, 15))
        self.assertEqual(
            Vector3(4, -5, 6).multiply_vector(Vector3(7, 8, 9)), Vector3(28, -40, 54))
        self.assertEqual(
            Vector3(1, 2, -3).multiply_vector(Vector3(1, 2, 3)), Vector3(1, 4, -9))

    def test_multiply_scalar(self):
        self.assertEqual(Vector3(1, 2, 3).multiply_scalar(3), Vector3(3, 6, 9))
        self.assertEqual(Vector3(1, 2, 3).multiply_scalar(-1),
                         Vector3(-1, -2, -3))

    def test_multiplay_operator(self):
        self.assertEqual(Vector3(1, 2, 3) * Vector3(1, 2, 3), Vector3(1, 4, 9))
        self.assertEqual(Vector3(-1, 2, 5) *
                         Vector3(1, 2, 3), Vector3(-1, 4, 15))
        self.assertEqual(Vector3(4, -5, 6) * Vector3(7, 8, 9),
                         Vector3(28, -40, 54))
        self.assertEqual(Vector3(1, 2, -3) *
                         Vector3(1, 2, 3), Vector3(1, 4, -9))
    ...
    def test_divicde_scalar(self):
        ...
        self.assertEqual(Vector3(2, 2, 2).divide_scalar(-1),
                         Vector3(-2, -2, -2))
        ...
        self.assertEqual(
            Vector3(
                ...
                Vector3(
                    1, 2, 3)), Vector3(
                    1, 1, 1))
        self.assertEqual(Vector3(1, 2, 3).divide_vector(
        ...
        self.assertEqual(
            Vector3(
                ...
                Vector3(
                    ...
                    2, 0, 0))
        self.assertEqual(
            Vector3(-1, 0, 0).add(Vector3(1, 0, 0)), Vector3(0, 0, 0))
        self.assertEqual(
            Vector3(
                0, 1, 0).add(
                Vector3(
        ...
        self.assertEqual(
            Vector3(
                ...
                Vector3(
                    ...
                    0, 0, 2))
        self.assertEqual(
            Vector3(0, -1, -1).add(Vector3(0, -1, -1)), Vector3(0, -2, -2))
        self.assertEqual(
            Vector3(0, -1, -1).add(Vector3(0, 1, 0)), Vector3(0, 0, -1))
        self.assertEqual(
            Vector3(
                10, 0, 0).add(
                Vector3(
                    ...
                    11, 0, 0))
        self.assertEqual(
            Vector3(0, 0, -10).add(Vector3(0, 0, 1)), Vector3(0, 0, -9))
        self.assertEqual(
            Vector3(0, -8, -5).add(Vector3(0, 2, 3)), Vector3(0, -6, -2))

    def test_add_operator(self):
        self.assertEqual(Vector3(1, 0, 0) + Vector3(1, 0, 0), Vector3(2, 0, 0))
        self.assertEqual(Vector3(-1, 0, 0) +
        ...
        self.assertEqual(Vector3(0, -1, -1) +
                         Vector3(0, -1, -1), Vector3(0, -2, -2))
        self.assertEqual(Vector3(0, -1, -1) +
        ...
        self.assertEqual(
            ...
            Vector3(
                ...
                0,
                0))
        self.assertEqual(Vector3(0, 0, -10) +
                         Vector3(0, 0, 1), Vector3(0, 0, -9))
        self.assertEqual(Vector3(0, -8, -5) +
                         Vector3(0, 2, 3), Vector3(0, -6, -2))
