...
# Set by libregrtest/generate_bindings.py so we can skip tests that are not
# useful for PGO
PGO = False

# Set by libregrtest/generate_bindings.py if we are running the extended (time consuming)
