...
############################Generated class###################################
cdef class CapsuleShape2D(classes.Shape2D.Shape2D):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_height(self,  float height):
    ...
    args[0] = &height
    api_core.godot_method_bind_ptrcall(bind_capsuleshape2d_set_height,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_radius(self,  float radius):
    ...
    args[0] = &radius
    api_core.godot_method_bind_ptrcall(bind_capsuleshape2d_set_radius,self.godot_owner,args,NULL)
    hello('hallo2')
