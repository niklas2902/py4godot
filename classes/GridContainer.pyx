...
############################Generated class###################################
cdef class GridContainer(classes.Container.Container):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_columns(self,  int columns):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &columns
    api_core.godot_method_bind_ptrcall(bind_gridcontainer_set_columns,self.godot_owner,args,NULL)
    hello('hallo2')
