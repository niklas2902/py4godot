...
cimport classes.CharFXTransform
...
############################Generated class###################################
cdef class RichTextEffect(classes.Resource.Resource):
  def __init__(self):
    super().__init__()
    nativescript_api_11.godot_nativescript_get_instance_binding_data(0, api_core.godot_get_class_constructor("RichTextEffect")())
##################################Generated Methods#########################################
  def  _process_custom_fx(self,  classes.CharFXTransform.CharFXTransform char_fx):
    ...
    args[0] = char_fx.godot_owner
    api_core.godot_method_bind_ptrcall(bind_richtexteffect__process_custom_fx,self.godot_owner,args,&ret)
    hello('hallo2')
