...
############################Generated class###################################
cdef class PHashTranslation(classes.Translation.Translation):
  def __init__(self):
    super().__init__()
    nativescript_api_11.godot_nativescript_get_instance_binding_data(0, api_core.godot_get_class_constructor("PHashTranslation")())
##################################Generated Methods#########################################
  def  generate(self,  classes.Translation.Translation from_):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = from_.godot_owner
    api_core.godot_method_bind_ptrcall(bind_phashtranslation_generate,self.godot_owner,args,NULL)
    hello('hallo2')
