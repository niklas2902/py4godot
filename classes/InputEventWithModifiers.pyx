...
##################################Generated Methods#########################################
  ...
  def  set_alt(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_inputeventwithmodifiers_set_alt,self.godot_owner,[NULL,],NULL)
  def  set_command(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_inputeventwithmodifiers_set_command,self.godot_owner,[NULL,],NULL)
  def  set_control(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_inputeventwithmodifiers_set_control,self.godot_owner,[NULL,],NULL)
  def  set_metakey(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_inputeventwithmodifiers_set_metakey,self.godot_owner,[NULL,],NULL)
  def  set_shift(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_inputeventwithmodifiers_set_shift,self.godot_owner,[NULL,],NULL)
