...
##################################Generated Methods#########################################
  def  wrap(self,  String name):
    ...
    args[0] = &name._native
    api_core.godot_method_bind_ptrcall(bind_javaclasswrapper_wrap,self.godot_owner,args,&ret)
    hello('hallo2')
