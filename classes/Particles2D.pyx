...
##################################Generated Methods#########################################
  ...
  def  get_draw_order(self):
    cdef godot_object *_owner = self.godot_owner
    cdef Particles2D::DrawOrder ret
  ...
  def  set_amount(self, amount):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_amount,self.godot_owner,[NULL,],NULL)
  def  set_draw_order(self, order):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_draw_order,self.godot_owner,[NULL,],NULL)
  def  set_emitting(self, emitting):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_emitting,self.godot_owner,[NULL,],NULL)
  def  set_explosiveness_ratio(self, ratio):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_explosiveness_ratio,self.godot_owner,[NULL,],NULL)
  def  set_fixed_fps(self, fps):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_fixed_fps,self.godot_owner,[NULL,],NULL)
  def  set_fractional_delta(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_fractional_delta,self.godot_owner,[NULL,],NULL)
  def  set_lifetime(self, secs):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_lifetime,self.godot_owner,[NULL,],NULL)
  def  set_normal_map(self, texture):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_normal_map,self.godot_owner,[NULL,],NULL)
  def  set_one_shot(self, secs):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_one_shot,self.godot_owner,[NULL,],NULL)
  def  set_pre_process_time(self, secs):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_pre_process_time,self.godot_owner,[NULL,],NULL)
  def  set_process_material(self, material):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_process_material,self.godot_owner,[NULL,],NULL)
  def  set_randomness_ratio(self, ratio):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_randomness_ratio,self.godot_owner,[NULL,],NULL)
  def  set_speed_scale(self, scale):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_speed_scale,self.godot_owner,[NULL,],NULL)
  def  set_texture(self, texture):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_texture,self.godot_owner,[NULL,],NULL)
  def  set_use_local_coordinates(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_use_local_coordinates,self.godot_owner,[NULL,],NULL)
  def  set_visibility_rect(self, visibility_rect):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_particles2d_set_visibility_rect,self.godot_owner,[NULL,],NULL)
