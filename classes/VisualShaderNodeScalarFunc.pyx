...
##################################Generated Methods#########################################
  def  get_function(self):
    ...
    cdef VisualShaderNodeScalarFunc::Function ret
    api_core.godot_method_bind_ptrcall(bind_visualshadernodescalarfunc_get_function,self.godot_owner,[NULL,],&ret)
  def  set_function(self, func):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_visualshadernodescalarfunc_set_function,self.godot_owner,[NULL,],NULL)
