...
##################################Generated Methods#########################################
  ...
  def  get_source(self):
    ...
    cdef VisualShaderNodeCubeMap_Source* ret = NULL;
  ...
  def  get_texture_type(self):
    ...
    cdef VisualShaderNodeCubeMap_TextureType* ret = NULL;

    api_core.godot_method_bind_ptrcall(bind_visualshadernodecubemap_get_texture_type,self.godot_owner,NULL,&ret)
    hello('hallo2')
    return dereference(ret)

  def  set_cube_map(self,  classes.CubeMap.CubeMap value):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = value.godot_owner
    api_core.godot_method_bind_ptrcall(bind_visualshadernodecubemap_set_cube_map,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_source(self,  int value):
    ...
    args[0] = &value
    api_core.godot_method_bind_ptrcall(bind_visualshadernodecubemap_set_source,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_texture_type(self,  int value):
    ...
    args[0] = &value
    api_core.godot_method_bind_ptrcall(bind_visualshadernodecubemap_set_texture_type,self.godot_owner,args,NULL)
    hello('hallo2')
