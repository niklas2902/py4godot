...
##################################Generated Methods#########################################
  ...
  def  get_input_caption(self, input):
    cdef godot_object *_owner = self.godot_owner
    cdef String ret
    api_core.godot_method_bind_ptrcall(bind_animationnodetransition_get_input_caption,self.godot_owner,[NULL,],&ret)
  def  is_input_set_as_auto_advance(self, input):
    cdef godot_object *_owner = self.godot_owner
    cdef bool ret
    api_core.godot_method_bind_ptrcall(bind_animationnodetransition_is_input_set_as_auto_advance,self.godot_owner,[NULL,],&ret)
  def  set_cross_fade_time(self, time):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodetransition_set_cross_fade_time,self.godot_owner,[NULL,],NULL)
  def  set_enabled_inputs(self, amount):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodetransition_set_enabled_inputs,self.godot_owner,[NULL,],NULL)
  def  set_input_as_auto_advance(self, inputenable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodetransition_set_input_as_auto_advance,self.godot_owner,[NULL,],NULL)
  def  set_input_caption(self, inputcaption):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodetransition_set_input_caption,self.godot_owner,[NULL,],NULL)
