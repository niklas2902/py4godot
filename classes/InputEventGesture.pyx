...
############################Generated class###################################
cdef class InputEventGesture(classes.InputEventWithModifiers.InputEventWithModifiers):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_position(self,  Vector2 position):
    ...
    api_core.godot_method_bind_ptrcall(bind_inputeventgesture_set_position,self.godot_owner,args,NULL)
    hello('hallo2')
