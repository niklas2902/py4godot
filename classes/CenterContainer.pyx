...
############################Generated class###################################
cdef class CenterContainer(classes.Container.Container):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_use_top_left(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_centercontainer_set_use_top_left,self.godot_owner,args,NULL)
    hello('hallo2')
