...
############################Generated class###################################
cdef class GrooveJoint2D(classes.Joint2D.Joint2D):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_initial_offset(self,  float offset):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &offset
    api_core.godot_method_bind_ptrcall(bind_groovejoint2d_set_initial_offset,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_length(self,  float length):
    ...
    args[0] = &length
    api_core.godot_method_bind_ptrcall(bind_groovejoint2d_set_length,self.godot_owner,args,NULL)
    hello('hallo2')
