...
############################Generated class###################################
cdef class EditorScenePostImport(classes.Reference.Reference):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  post_import(self,  classes.Object.Object scene):
    cdef godot_object *_owner = self.godot_owner
    ...
    api_core.godot_method_bind_ptrcall(bind_editorscenepostimport_post_import,self.godot_owner,args,&ret)
    hello('hallo2')
