...
############################Generated class###################################
cdef class InputEventMouseButton(classes.InputEventMouse.InputEventMouse):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_button_index(self,  int button_index):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &button_index
    api_core.godot_method_bind_ptrcall(bind_inputeventmousebutton_set_button_index,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_doubleclick(self,  bool doubleclick):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &doubleclick
    api_core.godot_method_bind_ptrcall(bind_inputeventmousebutton_set_doubleclick,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_factor(self,  float factor):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &factor
    api_core.godot_method_bind_ptrcall(bind_inputeventmousebutton_set_factor,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_pressed(self,  bool pressed):
    ...
    args[0] = &pressed
    api_core.godot_method_bind_ptrcall(bind_inputeventmousebutton_set_pressed,self.godot_owner,args,NULL)
    hello('hallo2')
