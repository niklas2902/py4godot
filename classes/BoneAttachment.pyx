...
############################Generated class###################################
cdef class BoneAttachment(classes.Spatial.Spatial):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_bone_name(self,  String bone_name):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &bone_name._native
    api_core.godot_method_bind_ptrcall(bind_boneattachment_set_bone_name,self.godot_owner,args,NULL)
    hello('hallo2')
