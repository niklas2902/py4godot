...
############################Generated class###################################
cdef class AnimationNodeAdd2(classes.AnimationNode.AnimationNode):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_use_sync(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_animationnodeadd2_set_use_sync,self.godot_owner,args,NULL)
    hello('hallo2')
