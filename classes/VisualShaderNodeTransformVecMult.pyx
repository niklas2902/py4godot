...
##################################Generated Methods#########################################
  def  get_operator(self):
    ...
    cdef VisualShaderNodeTransformVecMult_Operator* ret = NULL;
  ...
  def  set_operator(self,  int op):
    ...
    args[0] = &op
    api_core.godot_method_bind_ptrcall(bind_visualshadernodetransformvecmult_set_operator,self.godot_owner,args,NULL)
    hello('hallo2')
