...
############################Generated class###################################
cdef class InputEventMagnifyGesture(classes.InputEventGesture.InputEventGesture):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_factor(self,  float factor):
    ...
    args[0] = &factor
    api_core.godot_method_bind_ptrcall(bind_inputeventmagnifygesture_set_factor,self.godot_owner,args,NULL)
    hello('hallo2')
