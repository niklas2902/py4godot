...
##################################Generated Methods#########################################
  ...
  def  get_draw_order(self):
    cdef godot_object *_owner = self.godot_owner
    cdef CPUParticles2D::DrawOrder ret
  ...
  def  get_emission_shape(self):
    cdef godot_object *_owner = self.godot_owner
    cdef CPUParticles2D::EmissionShape ret
  ...
  def  get_param(self, param):
    cdef godot_object *_owner = self.godot_owner
    cdef float ret
    api_core.godot_method_bind_ptrcall(bind_cpuparticles2d_get_param,self.godot_owner,[NULL,],&ret)
  def  get_param_curve(self, param):
    cdef godot_object *_owner = self.godot_owner
    cdef Curve ret
    api_core.godot_method_bind_ptrcall(bind_cpuparticles2d_get_param_curve,self.godot_owner,[NULL,],&ret)
  def  get_param_randomness(self, param):
    cdef godot_object *_owner = self.godot_owner
    cdef float ret
    api_core.godot_method_bind_ptrcall(bind_cpuparticles2d_get_param_randomness,self.godot_owner,[NULL,],&ret)
  def  get_particle_flag(self, flag):
    cdef godot_object *_owner = self.godot_owner
    cdef bool ret
    api_core.godot_method_bind_ptrcall(bind_cpuparticles2d_get_particle_flag,self.godot_owner,[NULL,],&ret)
