...
############################Generated class###################################
cdef class CylinderShape(classes.Shape.Shape):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_height(self,  float height):
    ...
    args[0] = &height
    api_core.godot_method_bind_ptrcall(bind_cylindershape_set_height,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_radius(self,  float radius):
    ...
    args[0] = &radius
    api_core.godot_method_bind_ptrcall(bind_cylindershape_set_radius,self.godot_owner,args,NULL)
    hello('hallo2')
