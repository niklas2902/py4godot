...
##################################Generated Methods#########################################
  def  get_action_mode(self):
    ...
    cdef VisualScriptInputAction_Mode* ret = NULL;
  ...
  def  set_action_mode(self,  int mode):
    ...
    args[0] = &mode
    api_core.godot_method_bind_ptrcall(bind_visualscriptinputaction_set_action_mode,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_action_name(self,  String name):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &name._native
    api_core.godot_method_bind_ptrcall(bind_visualscriptinputaction_set_action_name,self.godot_owner,args,NULL)
    hello('hallo2')
