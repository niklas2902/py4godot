...
##################################Generated Methods#########################################
  ...
  def  set_brake(self, brake):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_brake,self.godot_owner,[NULL,],NULL)
  def  set_damping_compression(self, length):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_damping_compression,self.godot_owner,[NULL,],NULL)
  def  set_damping_relaxation(self, length):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_damping_relaxation,self.godot_owner,[NULL,],NULL)
  def  set_engine_force(self, engine_force):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_engine_force,self.godot_owner,[NULL,],NULL)
  def  set_friction_slip(self, length):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_friction_slip,self.godot_owner,[NULL,],NULL)
  def  set_radius(self, length):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_radius,self.godot_owner,[NULL,],NULL)
  def  set_roll_influence(self, roll_influence):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_roll_influence,self.godot_owner,[NULL,],NULL)
  def  set_steering(self, steering):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_steering,self.godot_owner,[NULL,],NULL)
  def  set_suspension_max_force(self, length):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_suspension_max_force,self.godot_owner,[NULL,],NULL)
  def  set_suspension_rest_length(self, length):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_suspension_rest_length,self.godot_owner,[NULL,],NULL)
  def  set_suspension_stiffness(self, length):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_suspension_stiffness,self.godot_owner,[NULL,],NULL)
  def  set_suspension_travel(self, length):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_suspension_travel,self.godot_owner,[NULL,],NULL)
  def  set_use_as_steering(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_use_as_steering,self.godot_owner,[NULL,],NULL)
  def  set_use_as_traction(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_vehiclewheel_set_use_as_traction,self.godot_owner,[NULL,],NULL)
