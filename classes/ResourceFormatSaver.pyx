...
############################Generated class###################################
cdef class ResourceFormatSaver(classes.Reference.Reference):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  def  get_recognized_extensions(self,  classes.Resource.Resource resource):
    ...
    api_core.godot_method_bind_ptrcall(bind_resourceformatsaver_get_recognized_extensions,self.godot_owner,args,&ret)
    hello('hallo2')
  def  recognize(self,  classes.Resource.Resource resource):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = resource.godot_owner
    api_core.godot_method_bind_ptrcall(bind_resourceformatsaver_recognize,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)

  def  save(self,  String path,  classes.Resource.Resource resource,  int flags):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[2] = &flags
    api_core.godot_method_bind_ptrcall(bind_resourceformatsaver_save,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
