...
##################################Generated Methods#########################################
  ...
  def  _set_type_cache(self,  int type_cache):
    ...
    args[0] = &type_cache
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyget__set_type_cache,self.godot_owner,args,NULL)
    hello('hallo2')
  ...
  def  set_base_path(self,  NodePath base_path):
    ...
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyget_set_base_path,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_base_script(self,  String base_script):
    ...
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyget_set_base_script,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_base_type(self,  String base_type):
    ...
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyget_set_base_type,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_basic_type(self,  int basic_type):
    ...
    args[0] = &basic_type
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyget_set_basic_type,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_call_mode(self,  int mode):
    ...
    args[0] = &mode
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyget_set_call_mode,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_index(self,  String index):
    ...
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyget_set_index,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_property(self,  String property):
    ...
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyget_set_property,self.godot_owner,args,NULL)
    hello('hallo2')
