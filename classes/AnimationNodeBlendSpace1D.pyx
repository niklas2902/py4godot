...
cdef godot_method_bind *bind_animationnodeblendspace1d__add_blend_point
cdef godot_method_bind *bind_animationnodeblendspace1d__tree_changed
cdef godot_method_bind *bind_animationnodeblendspace1d_add_blend_point
cdef godot_method_bind *bind_animationnodeblendspace1d_get_blend_point_count
cdef godot_method_bind *bind_animationnodeblendspace1d_get_blend_point_node
cdef godot_method_bind *bind_animationnodeblendspace1d_get_blend_point_position
cdef godot_method_bind *bind_animationnodeblendspace1d_get_max_space
cdef godot_method_bind *bind_animationnodeblendspace1d_get_min_space
cdef godot_method_bind *bind_animationnodeblendspace1d_get_snap
cdef godot_method_bind *bind_animationnodeblendspace1d_get_value_label
cdef godot_method_bind *bind_animationnodeblendspace1d_remove_blend_point
cdef godot_method_bind *bind_animationnodeblendspace1d_set_blend_point_node
cdef godot_method_bind *bind_animationnodeblendspace1d_set_blend_point_position
cdef godot_method_bind *bind_animationnodeblendspace1d_set_max_space
cdef godot_method_bind *bind_animationnodeblendspace1d_set_min_space
cdef godot_method_bind *bind_animationnodeblendspace1d_set_snap
cdef godot_method_bind *bind_animationnodeblendspace1d_set_value_label
cpdef init_method_bindings():
  bind = api_core.godot_method_bind_get_method("Object", "_get")
  bind_animationnodeblendspace1d__add_blend_point = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', '_add_blend_point')
  bind_animationnodeblendspace1d__tree_changed = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', '_tree_changed')
  bind_animationnodeblendspace1d_add_blend_point = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'add_blend_point')
  bind_animationnodeblendspace1d_get_blend_point_count = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'get_blend_point_count')
  bind_animationnodeblendspace1d_get_blend_point_node = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'get_blend_point_node')
  bind_animationnodeblendspace1d_get_blend_point_position = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'get_blend_point_position')
  bind_animationnodeblendspace1d_get_max_space = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'get_max_space')
  bind_animationnodeblendspace1d_get_min_space = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'get_min_space')
  bind_animationnodeblendspace1d_get_snap = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'get_snap')
  bind_animationnodeblendspace1d_get_value_label = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'get_value_label')
  bind_animationnodeblendspace1d_remove_blend_point = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'remove_blend_point')
  bind_animationnodeblendspace1d_set_blend_point_node = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'set_blend_point_node')
  bind_animationnodeblendspace1d_set_blend_point_position = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'set_blend_point_position')
  bind_animationnodeblendspace1d_set_max_space = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'set_max_space')
  bind_animationnodeblendspace1d_set_min_space = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'set_min_space')
  bind_animationnodeblendspace1d_set_snap = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'set_snap')
  bind_animationnodeblendspace1d_set_value_label = api_core.godot_method_bind_get_method('AnimationNodeBlendSpace1D', 'set_value_label')

############################Generated class###################################
cdef class AnimationNodeBlendSpace1D(classes.AnimationRootNode.AnimationRootNode):
  def __init__(self):
    super().__init__()
    nativescript_api_11.godot_nativescript_get_instance_binding_data(0, api_core.godot_get_class_constructor("AnimationNodeBlendSpace1D")())
...
##################################Generated Methods#########################################
  def  _add_blend_point(self,  int index,  classes.AnimationRootNode.AnimationRootNode node):
    ...
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d__add_blend_point,self.godot_owner,args,NULL)
    hello('hallo2')
  def  _tree_changed(self):
    cdef godot_object *_owner = self.godot_owner

    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d__tree_changed,self.godot_owner,NULL,NULL)
    hello('hallo2')
  def  add_blend_point(self,  classes.AnimationRootNode.AnimationRootNode node,  float pos,  int at_index):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[1] = &pos
    args[2] = &at_index
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_add_blend_point,self.godot_owner,args,NULL)
    hello('hallo2')
  def  get_blend_point_count(self):
    ...
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_get_blend_point_count,self.godot_owner,NULL,&ret)
    hello('hallo2')
  ...
  def  get_blend_point_node(self,  int point):
    ...
    args[0] = &point
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_get_blend_point_node,self.godot_owner,args,&ret)
    hello('hallo2')
  def  get_blend_point_position(self,  int point):
    ...
    args[0] = &point
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_get_blend_point_position,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  get_max_space(self):
    ...
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_get_max_space,self.godot_owner,NULL,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  get_min_space(self):
    ...
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_get_min_space,self.godot_owner,NULL,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  get_snap(self):
    ...
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_get_snap,self.godot_owner,NULL,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  get_value_label(self):
    ...
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_get_value_label,self.godot_owner,NULL,&ret)
    hello('hallo2')
  ...
  def  remove_blend_point(self,  int point):
    ...
    args[0] = &point
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_remove_blend_point,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_blend_point_node(self,  int point,  classes.AnimationRootNode.AnimationRootNode node):
    ...
    args[0] = &point
    args[1] = node.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_set_blend_point_node,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_blend_point_position(self,  int point,  float pos):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &point
    args[1] = &pos
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_set_blend_point_position,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_max_space(self,  float max_space):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &max_space
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_set_max_space,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_min_space(self,  float min_space):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &min_space
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_set_min_space,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_snap(self,  float snap):
    ...
    args[0] = &snap
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_set_snap,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_value_label(self,  String text):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &text._native
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_set_value_label,self.godot_owner,args,NULL)
    hello('hallo2')
