...
##################################Generated Methods#########################################
  def  _add_blend_point(self, indexnode):
    ...
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d__add_blend_point,self.godot_owner,[NULL,],NULL)
  ...
  def  add_blend_point(self, nodeposat_index):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_add_blend_point,self.godot_owner,[NULL,],NULL)
  ...
  def  get_blend_point_node(self, point):
    ...
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_get_blend_point_node,self.godot_owner,[NULL,],&ret)
  def  get_blend_point_position(self, point):
    cdef godot_object *_owner = self.godot_owner
    cdef float ret
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_get_blend_point_position,self.godot_owner,[NULL,],&ret)
  ...
  def  remove_blend_point(self, point):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_remove_blend_point,self.godot_owner,[NULL,],NULL)
  def  set_blend_point_node(self, pointnode):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_set_blend_point_node,self.godot_owner,[NULL,],NULL)
  def  set_blend_point_position(self, pointpos):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_set_blend_point_position,self.godot_owner,[NULL,],NULL)
  def  set_max_space(self, max_space):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_set_max_space,self.godot_owner,[NULL,],NULL)
  def  set_min_space(self, min_space):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_set_min_space,self.godot_owner,[NULL,],NULL)
  def  set_snap(self, snap):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_set_snap,self.godot_owner,[NULL,],NULL)
  def  set_value_label(self, text):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_animationnodeblendspace1d_set_value_label,self.godot_owner,[NULL,],NULL)
