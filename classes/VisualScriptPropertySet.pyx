...
##################################Generated Methods#########################################
  ...
  def  _set_type_cache(self, type_cache):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyset__set_type_cache,self.godot_owner,[NULL,],NULL)
  def  get_assign_op(self):
    cdef godot_object *_owner = self.godot_owner
    cdef VisualScriptPropertySet::AssignOp ret
  ...
  def  get_call_mode(self):
    cdef godot_object *_owner = self.godot_owner
    cdef VisualScriptPropertySet::CallMode ret
  ...
  def  set_assign_op(self, assign_op):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyset_set_assign_op,self.godot_owner,[NULL,],NULL)
  def  set_base_path(self, base_path):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyset_set_base_path,self.godot_owner,[NULL,],NULL)
  def  set_base_script(self, base_script):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyset_set_base_script,self.godot_owner,[NULL,],NULL)
  def  set_base_type(self, base_type):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyset_set_base_type,self.godot_owner,[NULL,],NULL)
  def  set_basic_type(self, basic_type):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyset_set_basic_type,self.godot_owner,[NULL,],NULL)
  def  set_call_mode(self, mode):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyset_set_call_mode,self.godot_owner,[NULL,],NULL)
  def  set_index(self, index):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyset_set_index,self.godot_owner,[NULL,],NULL)
  def  set_property(self, property):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_visualscriptpropertyset_set_property,self.godot_owner,[NULL,],NULL)
