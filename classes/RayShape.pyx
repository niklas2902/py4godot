...
##################################Generated Methods#########################################
  ...
  def  set_length(self, length):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_rayshape_set_length,self.godot_owner,[NULL,],NULL)
  def  set_slips_on_slope(self, active):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_rayshape_set_slips_on_slope,self.godot_owner,[NULL,],NULL)
