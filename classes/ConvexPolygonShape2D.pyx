...
############################Generated class###################################
cdef class ConvexPolygonShape2D(classes.Shape2D.Shape2D):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  def  get_points(self):
    ...
    hello('hallo2')
  def  set_point_cloud(self,  PoolVector2Array point_cloud):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &point_cloud._native
    api_core.godot_method_bind_ptrcall(bind_convexpolygonshape2d_set_point_cloud,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_points(self,  PoolVector2Array points):
    ...
    api_core.godot_method_bind_ptrcall(bind_convexpolygonshape2d_set_points,self.godot_owner,args,NULL)
    hello('hallo2')
