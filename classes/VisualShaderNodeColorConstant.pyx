...
############################Generated class###################################
cdef class VisualShaderNodeColorConstant(classes.VisualShaderNode.VisualShaderNode):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_constant(self,  Color value):
    ...
    api_core.godot_method_bind_ptrcall(bind_visualshadernodecolorconstant_set_constant,self.godot_owner,args,NULL)
    hello('hallo2')
