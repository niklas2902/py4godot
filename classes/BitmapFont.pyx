...
##################################Generated Methods#########################################
  ...
  def  _set_chars(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_bitmapfont__set_chars,self.godot_owner,[NULL,],NULL)
  def  _set_kernings(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_bitmapfont__set_kernings,self.godot_owner,[NULL,],NULL)
  def  _set_textures(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_bitmapfont__set_textures,self.godot_owner,[NULL,],NULL)
  def  add_char(self, charactertexturerectalignadvance):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_add_char,self.godot_owner,[NULL,],NULL)
  def  add_kerning_pair(self, char_achar_bkerning):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_add_kerning_pair,self.godot_owner,[NULL,],NULL)
  def  add_texture(self, texture):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_add_texture,self.godot_owner,[NULL,],NULL)
  def  clear(self):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_clear,self.godot_owner,[NULL,],NULL)
  def  create_from_fnt(self, path):
    cdef godot_object *_owner = self.godot_owner
    cdef Error ret
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_create_from_fnt,self.godot_owner,[NULL,],&ret)
  def  get_char_size(self, charnext):
    cdef godot_object *_owner = self.godot_owner
    cdef Vector2 ret
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_get_char_size,self.godot_owner,[NULL,],&ret)
  def  get_fallback(self):
    cdef godot_object *_owner = self.godot_owner
    cdef BitmapFont ret
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_get_fallback,self.godot_owner,[NULL,],&ret)
  def  get_kerning_pair(self, char_achar_b):
    cdef godot_object *_owner = self.godot_owner
    cdef int ret
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_get_kerning_pair,self.godot_owner,[NULL,],&ret)
  def  get_texture(self, idx):
    cdef godot_object *_owner = self.godot_owner
    cdef Texture ret
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_get_texture,self.godot_owner,[NULL,],&ret)
  def  get_texture_count(self):
    cdef godot_object *_owner = self.godot_owner
    cdef int ret
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_get_texture_count,self.godot_owner,[NULL,],&ret)
  def  set_ascent(self, px):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_set_ascent,self.godot_owner,[NULL,],NULL)
  def  set_distance_field_hint(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_set_distance_field_hint,self.godot_owner,[NULL,],NULL)
  def  set_fallback(self, fallback):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_set_fallback,self.godot_owner,[NULL,],NULL)
  def  set_height(self, px):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_bitmapfont_set_height,self.godot_owner,[NULL,],NULL)
