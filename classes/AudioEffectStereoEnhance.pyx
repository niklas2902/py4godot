...
############################Generated class###################################
cdef class AudioEffectStereoEnhance(classes.AudioEffect.AudioEffect):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_pan_pullout(self,  float amount):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &amount
    api_core.godot_method_bind_ptrcall(bind_audioeffectstereoenhance_set_pan_pullout,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_surround(self,  float amount):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &amount
    api_core.godot_method_bind_ptrcall(bind_audioeffectstereoenhance_set_surround,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_time_pullout(self,  float amount):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &amount
    api_core.godot_method_bind_ptrcall(bind_audioeffectstereoenhance_set_time_pullout,self.godot_owner,args,NULL)
    hello('hallo2')
