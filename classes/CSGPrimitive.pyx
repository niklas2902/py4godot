...
############################Generated class###################################
cdef class CSGPrimitive(classes.CSGShape.CSGShape):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_invert_faces(self,  bool invert_faces):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &invert_faces
    api_core.godot_method_bind_ptrcall(bind_csgprimitive_set_invert_faces,self.godot_owner,args,NULL)
    hello('hallo2')
