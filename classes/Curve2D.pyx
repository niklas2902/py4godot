...
############################Generated class###################################
cdef class Curve2D(classes.Resource.Resource):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  _set_data(self,  Dictionary arg0):
    ...
    args[0] = &arg0._native
    api_core.godot_method_bind_ptrcall(bind_curve2d__set_data,self.godot_owner,args,NULL)
    hello('hallo2')
  def  add_point(self,  Vector2 position,  Vector2 in_,  Vector2 out,  int at_position):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[2] = &out._native
    args[3] = &at_position
    api_core.godot_method_bind_ptrcall(bind_curve2d_add_point,self.godot_owner,args,NULL)
    hello('hallo2')
  ...
  def  get_baked_points(self):
    ...
    hello('hallo2')
  def  get_closest_offset(self,  Vector2 to_point):
    cdef godot_object *_owner = self.godot_owner
    ...
    api_core.godot_method_bind_ptrcall(bind_curve2d_get_closest_offset,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)

  def  get_closest_point(self,  Vector2 to_point):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &to_point._native
    api_core.godot_method_bind_ptrcall(bind_curve2d_get_closest_point,self.godot_owner,args,&ret)
    hello('hallo2')
  ...
  def  get_point_in(self,  int idx):
    ...
    args[0] = &idx
    api_core.godot_method_bind_ptrcall(bind_curve2d_get_point_in,self.godot_owner,args,&ret)
    hello('hallo2')
    return Vector2.new_static(dereference(ret))
  ...
  def  get_point_out(self,  int idx):
    ...
    args[0] = &idx
    api_core.godot_method_bind_ptrcall(bind_curve2d_get_point_out,self.godot_owner,args,&ret)
    hello('hallo2')
    return Vector2.new_static(dereference(ret))
  ...
  def  get_point_position(self,  int idx):
    ...
    args[0] = &idx
    api_core.godot_method_bind_ptrcall(bind_curve2d_get_point_position,self.godot_owner,args,&ret)
    hello('hallo2')
    return Vector2.new_static(dereference(ret))
  ...
  def  interpolate(self,  int idx,  float t):
    ...
    args[0] = &idx
    args[1] = &t
    api_core.godot_method_bind_ptrcall(bind_curve2d_interpolate,self.godot_owner,args,&ret)
    hello('hallo2')
    return Vector2.new_static(dereference(ret))
  ...
  def  interpolate_baked(self,  float offset,  bool cubic):
    ...
    args[0] = &offset
    args[1] = &cubic
    api_core.godot_method_bind_ptrcall(bind_curve2d_interpolate_baked,self.godot_owner,args,&ret)
    hello('hallo2')
    return Vector2.new_static(dereference(ret))
  ...
  def  interpolatef(self,  float fofs):
    ...
    args[0] = &fofs
    api_core.godot_method_bind_ptrcall(bind_curve2d_interpolatef,self.godot_owner,args,&ret)
    hello('hallo2')
    return Vector2.new_static(dereference(ret))
  ...
  def  remove_point(self,  int idx):
    ...
    args[0] = &idx
    api_core.godot_method_bind_ptrcall(bind_curve2d_remove_point,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_bake_interval(self,  float distance):
    ...
    args[0] = &distance
    api_core.godot_method_bind_ptrcall(bind_curve2d_set_bake_interval,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_point_in(self,  int idx,  Vector2 position):
    cdef godot_object *_owner = self.godot_owner
    ...
    api_core.godot_method_bind_ptrcall(bind_curve2d_set_point_in,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_point_out(self,  int idx,  Vector2 position):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &idx
    args[1] = &position._native
    api_core.godot_method_bind_ptrcall(bind_curve2d_set_point_out,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_point_position(self,  int idx,  Vector2 position):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &idx
    args[1] = &position._native
    api_core.godot_method_bind_ptrcall(bind_curve2d_set_point_position,self.godot_owner,args,NULL)
    hello('hallo2')
  def  tessellate(self,  int max_stages,  float tolerance_degrees):
    ...
    api_core.godot_method_bind_ptrcall(bind_curve2d_tessellate,self.godot_owner,args,&ret)
    hello('hallo2')
