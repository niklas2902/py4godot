...
##################################Generated Methods#########################################
  def  add_exception(self, node):
    ...
    api_core.godot_method_bind_ptrcall(bind_raycast2d_add_exception,self.godot_owner,[NULL,],NULL)
  def  add_exception_rid(self, rid):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_raycast2d_add_exception_rid,self.godot_owner,[NULL,],NULL)
  ...
  def  get_collision_mask_bit(self, bit):
    cdef godot_object *_owner = self.godot_owner
    cdef bool ret
    api_core.godot_method_bind_ptrcall(bind_raycast2d_get_collision_mask_bit,self.godot_owner,[NULL,],&ret)
  ...
  def  remove_exception(self, node):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_raycast2d_remove_exception,self.godot_owner,[NULL,],NULL)
  def  remove_exception_rid(self, rid):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_raycast2d_remove_exception_rid,self.godot_owner,[NULL,],NULL)
  def  set_cast_to(self, local_point):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_raycast2d_set_cast_to,self.godot_owner,[NULL,],NULL)
  def  set_collide_with_areas(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_raycast2d_set_collide_with_areas,self.godot_owner,[NULL,],NULL)
  def  set_collide_with_bodies(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_raycast2d_set_collide_with_bodies,self.godot_owner,[NULL,],NULL)
  def  set_collision_mask(self, mask):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_raycast2d_set_collision_mask,self.godot_owner,[NULL,],NULL)
  def  set_collision_mask_bit(self, bitvalue):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_raycast2d_set_collision_mask_bit,self.godot_owner,[NULL,],NULL)
  def  set_enabled(self, enabled):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_raycast2d_set_enabled,self.godot_owner,[NULL,],NULL)
  def  set_exclude_parent_body(self, mask):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_raycast2d_set_exclude_parent_body,self.godot_owner,[NULL,],NULL)
