...
##################################Generated Methods#########################################
  def  get_magnitude_for_frequency_range(self,  float from_hz,  float to_hz,  int mode):
    ...
    args[1] = &to_hz
    args[2] = &mode
    api_core.godot_method_bind_ptrcall(bind_audioeffectspectrumanalyzerinstance_get_magnitude_for_frequency_range,self.godot_owner,args,&ret)
    hello('hallo2')
