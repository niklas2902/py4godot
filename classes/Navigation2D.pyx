...
############################Generated class###################################
cdef class Navigation2D(classes.Node2D.Node2D):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  def  get_closest_point(self,  Vector2 to_point):
    ...
    api_core.godot_method_bind_ptrcall(bind_navigation2d_get_closest_point,self.godot_owner,args,&ret)
    hello('hallo2')
    return Vector2.new_static(dereference(ret))

  def  get_closest_point_owner(self,  Vector2 to_point):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &to_point._native
    api_core.godot_method_bind_ptrcall(bind_navigation2d_get_closest_point_owner,self.godot_owner,args,&ret)
    hello('hallo2')
  def  get_simple_path(self,  Vector2 start,  Vector2 end,  bool optimize):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[1] = &end._native
    args[2] = &optimize
    api_core.godot_method_bind_ptrcall(bind_navigation2d_get_simple_path,self.godot_owner,args,&ret)
    hello('hallo2')
  def  navpoly_add(self,  classes.NavigationPolygon.NavigationPolygon mesh,  Transform2D xform,  classes.Object.Object owner):
    cdef godot_object *_owner = self.godot_owner
    ...
    api_core.godot_method_bind_ptrcall(bind_navigation2d_navpoly_add,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)

  def  navpoly_remove(self,  int id):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &id
    api_core.godot_method_bind_ptrcall(bind_navigation2d_navpoly_remove,self.godot_owner,args,NULL)
    hello('hallo2')
  def  navpoly_set_transform(self,  int id,  Transform2D xform):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &id
    args[1] = &xform._native
    api_core.godot_method_bind_ptrcall(bind_navigation2d_navpoly_set_transform,self.godot_owner,args,NULL)
    hello('hallo2')
