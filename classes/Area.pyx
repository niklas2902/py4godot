...
##################################Generated Methods#########################################
  def  _area_enter_tree(self,  int id):
    ...
    args[0] = &id
    api_core.godot_method_bind_ptrcall(bind_area__area_enter_tree,self.godot_owner,args,NULL)
    hello('hallo2')
  def  _area_exit_tree(self,  int id):
    ...
    args[0] = &id
    api_core.godot_method_bind_ptrcall(bind_area__area_exit_tree,self.godot_owner,args,NULL)
    hello('hallo2')
  def  _area_inout(self,  int arg0,  RID arg1,  int arg2,  int arg3,  int arg4):
    ...
    args[3] = &arg3
    args[4] = &arg4
    api_core.godot_method_bind_ptrcall(bind_area__area_inout,self.godot_owner,args,NULL)
    hello('hallo2')
  def  _body_enter_tree(self,  int id):
    ...
    args[0] = &id
    api_core.godot_method_bind_ptrcall(bind_area__body_enter_tree,self.godot_owner,args,NULL)
    hello('hallo2')
  def  _body_exit_tree(self,  int id):
    ...
    args[0] = &id
    api_core.godot_method_bind_ptrcall(bind_area__body_exit_tree,self.godot_owner,args,NULL)
    hello('hallo2')
  def  _body_inout(self,  int arg0,  RID arg1,  int arg2,  int arg3,  int arg4):
    ...
    args[3] = &arg3
    args[4] = &arg4
    api_core.godot_method_bind_ptrcall(bind_area__body_inout,self.godot_owner,args,NULL)
    hello('hallo2')
  ...
  def  get_collision_layer_bit(self,  int bit):
    ...
    args[0] = &bit
    api_core.godot_method_bind_ptrcall(bind_area_get_collision_layer_bit,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  get_collision_mask_bit(self,  int bit):
    ...
    args[0] = &bit
    api_core.godot_method_bind_ptrcall(bind_area_get_collision_mask_bit,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  get_space_override_mode(self):
    ...
    cdef Area_SpaceOverride* ret = NULL;
  ...
  def  overlaps_area(self,  classes.Node.Node area):
    ...
    api_core.godot_method_bind_ptrcall(bind_area_overlaps_area,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  overlaps_body(self,  classes.Node.Node body):
    ...
    api_core.godot_method_bind_ptrcall(bind_area_overlaps_body,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  set_angular_damp(self,  float angular_damp):
    ...
    args[0] = &angular_damp
    api_core.godot_method_bind_ptrcall(bind_area_set_angular_damp,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_audio_bus(self,  String name):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &name._native
    api_core.godot_method_bind_ptrcall(bind_area_set_audio_bus,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_audio_bus_override(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_area_set_audio_bus_override,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_collision_layer(self,  int collision_layer):
    ...
    api_core.godot_method_bind_ptrcall(bind_area_set_collision_layer,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_collision_layer_bit(self,  int bit,  bool value):
    ...
    args[0] = &bit
    args[1] = &value
    api_core.godot_method_bind_ptrcall(bind_area_set_collision_layer_bit,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_collision_mask(self,  int collision_mask):
    ...
    api_core.godot_method_bind_ptrcall(bind_area_set_collision_mask,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_collision_mask_bit(self,  int bit,  bool value):
    ...
    args[0] = &bit
    args[1] = &value
    api_core.godot_method_bind_ptrcall(bind_area_set_collision_mask_bit,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_gravity(self,  float gravity):
    ...
    args[0] = &gravity
    api_core.godot_method_bind_ptrcall(bind_area_set_gravity,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_gravity_distance_scale(self,  float distance_scale):
    ...
    api_core.godot_method_bind_ptrcall(bind_area_set_gravity_distance_scale,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_gravity_is_point(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_area_set_gravity_is_point,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_gravity_vector(self,  Vector3 vector):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &vector._native
    api_core.godot_method_bind_ptrcall(bind_area_set_gravity_vector,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_linear_damp(self,  float linear_damp):
    ...
    args[0] = &linear_damp
    api_core.godot_method_bind_ptrcall(bind_area_set_linear_damp,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_monitorable(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_area_set_monitorable,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_monitoring(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_area_set_monitoring,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_priority(self,  float priority):
    ...
    args[0] = &priority
    api_core.godot_method_bind_ptrcall(bind_area_set_priority,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_reverb_amount(self,  float amount):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &amount
    api_core.godot_method_bind_ptrcall(bind_area_set_reverb_amount,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_reverb_bus(self,  String name):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &name._native
    api_core.godot_method_bind_ptrcall(bind_area_set_reverb_bus,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_reverb_uniformity(self,  float amount):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &amount
    api_core.godot_method_bind_ptrcall(bind_area_set_reverb_uniformity,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_space_override_mode(self,  int enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_area_set_space_override_mode,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_use_reverb_bus(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_area_set_use_reverb_bus,self.godot_owner,args,NULL)
    hello('hallo2')
