...
############################Generated class###################################
cdef class PhysicsShapeQueryResult(classes.Reference.Reference):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  get_result_object(self,  int idx):
    ...
    args[0] = &idx
    api_core.godot_method_bind_ptrcall(bind_physicsshapequeryresult_get_result_object,self.godot_owner,args,&ret)
    hello('hallo2')
  def  get_result_object_id(self,  int idx):
    ...
    args[0] = &idx
    api_core.godot_method_bind_ptrcall(bind_physicsshapequeryresult_get_result_object_id,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  get_result_object_shape(self,  int idx):
    ...
    args[0] = &idx
    api_core.godot_method_bind_ptrcall(bind_physicsshapequeryresult_get_result_object_shape,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  get_result_rid(self,  int idx):
    ...
    args[0] = &idx
    api_core.godot_method_bind_ptrcall(bind_physicsshapequeryresult_get_result_rid,self.godot_owner,args,&ret)
    hello('hallo2')
