...
############################Generated class###################################
cdef class AnimatedTexture(classes.Texture.Texture):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  get_frame_delay(self,  int frame):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &frame
    api_core.godot_method_bind_ptrcall(bind_animatedtexture_get_frame_delay,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)

  def  get_frame_texture(self,  int frame):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &frame
    api_core.godot_method_bind_ptrcall(bind_animatedtexture_get_frame_texture,self.godot_owner,args,&ret)
    hello('hallo2')
  def  get_frames(self):
    cdef godot_object *_owner = self.godot_owner
  ...
  def  set_fps(self,  float fps):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &fps
    api_core.godot_method_bind_ptrcall(bind_animatedtexture_set_fps,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_frame_delay(self,  int frame,  float delay):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &frame
    args[1] = &delay
    api_core.godot_method_bind_ptrcall(bind_animatedtexture_set_frame_delay,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_frame_texture(self,  int frame,  classes.Texture.Texture texture):
    cdef godot_object *_owner = self.godot_owner
    ...
    api_core.godot_method_bind_ptrcall(bind_animatedtexture_set_frame_texture,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_frames(self,  int frames):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &frames
    api_core.godot_method_bind_ptrcall(bind_animatedtexture_set_frames,self.godot_owner,args,NULL)
    hello('hallo2')
