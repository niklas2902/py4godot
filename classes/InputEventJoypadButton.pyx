...
##################################Generated Methods#########################################
  ...
  def  set_button_index(self,  int button_index):
    ...
    args[0] = &button_index
    api_core.godot_method_bind_ptrcall(bind_inputeventjoypadbutton_set_button_index,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_pressed(self,  bool pressed):
    ...
    args[0] = &pressed
    api_core.godot_method_bind_ptrcall(bind_inputeventjoypadbutton_set_pressed,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_pressure(self,  float pressure):
    ...
    args[0] = &pressure
    api_core.godot_method_bind_ptrcall(bind_inputeventjoypadbutton_set_pressure,self.godot_owner,args,NULL)
    hello('hallo2')
