from classes.PanelContainer cimport * 
...
##################################Generated Methods#########################################
  def  _add_callback(self, arg0arg1arg2):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__add_callback,self.godot_owner,[NULL,],NULL)
  ...
  def  _breaked(self, arg0arg1):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__breaked,self.godot_owner,[NULL,],NULL)
  def  _clear_execution(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__clear_execution,self.godot_owner,[NULL,],NULL)
  ...
  def  _close_discard_current_tab(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__close_discard_current_tab,self.godot_owner,[NULL,],NULL)
  ...
  def  _file_dialog_action(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__file_dialog_action,self.godot_owner,[NULL,],NULL)
  def  _filter_methods_text_changed(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__filter_methods_text_changed,self.godot_owner,[NULL,],NULL)
  def  _filter_scripts_text_changed(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__filter_scripts_text_changed,self.godot_owner,[NULL,],NULL)
  def  _get_debug_tooltip(self, arg0arg1):
    cdef godot_object *_owner = self.godot_owner
    cdef String ret
    api_core.godot_method_bind_ptrcall(bind_scripteditor__get_debug_tooltip,self.godot_owner,[NULL,],&ret)
  def  _goto_script_line(self, arg0arg1):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__goto_script_line,self.godot_owner,[NULL,],NULL)
  def  _goto_script_line2(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__goto_script_line2,self.godot_owner,[NULL,],NULL)
  def  _help_class_goto(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__help_class_goto,self.godot_owner,[NULL,],NULL)
  def  _help_class_open(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__help_class_open,self.godot_owner,[NULL,],NULL)
  def  _help_overview_selected(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__help_overview_selected,self.godot_owner,[NULL,],NULL)
  def  _help_search(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__help_search,self.godot_owner,[NULL,],NULL)
  ...
  def  _members_overview_selected(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__members_overview_selected,self.godot_owner,[NULL,],NULL)
  def  _menu_option(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__menu_option,self.godot_owner,[NULL,],NULL)
  def  _on_find_in_files_modified_files(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__on_find_in_files_modified_files,self.godot_owner,[NULL,],NULL)
  def  _on_find_in_files_requested(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__on_find_in_files_requested,self.godot_owner,[NULL,],NULL)
  def  _on_find_in_files_result_selected(self, arg0arg1arg2arg3):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__on_find_in_files_result_selected,self.godot_owner,[NULL,],NULL)
  def  _open_recent_script(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__open_recent_script,self.godot_owner,[NULL,],NULL)
  def  _reload_scripts(self):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__reload_scripts,self.godot_owner,[NULL,],NULL)
  def  _request_help(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__request_help,self.godot_owner,[NULL,],NULL)
  def  _res_saved_callback(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__res_saved_callback,self.godot_owner,[NULL,],NULL)
  def  _resave_scripts(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__resave_scripts,self.godot_owner,[NULL,],NULL)
  ...
  def  _script_created(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__script_created,self.godot_owner,[NULL,],NULL)
  def  _script_list_gui_input(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__script_list_gui_input,self.godot_owner,[NULL,],NULL)
  def  _script_selected(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__script_selected,self.godot_owner,[NULL,],NULL)
  def  _script_split_dragged(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__script_split_dragged,self.godot_owner,[NULL,],NULL)
  def  _set_execution(self, arg0arg1):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__set_execution,self.godot_owner,[NULL,],NULL)
  def  _show_debugger(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__show_debugger,self.godot_owner,[NULL,],NULL)
  def  _start_find_in_files(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__start_find_in_files,self.godot_owner,[NULL,],NULL)
  def  _tab_changed(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__tab_changed,self.godot_owner,[NULL,],NULL)
  def  _theme_option(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__theme_option,self.godot_owner,[NULL,],NULL)
  def  _toggle_members_overview_alpha_sort(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__toggle_members_overview_alpha_sort,self.godot_owner,[NULL,],NULL)
  ...
  def  _unhandled_input(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor__unhandled_input,self.godot_owner,[NULL,],NULL)
  ...
  def  can_drop_data_fw(self, pointdatafrom_):
    cdef godot_object *_owner = self.godot_owner
    cdef bool ret
    api_core.godot_method_bind_ptrcall(bind_scripteditor_can_drop_data_fw,self.godot_owner,[NULL,],&ret)
  def  drop_data_fw(self, pointdatafrom_):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor_drop_data_fw,self.godot_owner,[NULL,],NULL)
  def  get_current_script(self):
    cdef godot_object *_owner = self.godot_owner
    cdef Script ret
    api_core.godot_method_bind_ptrcall(bind_scripteditor_get_current_script,self.godot_owner,[NULL,],&ret)
  def  get_drag_data_fw(self, pointfrom_):
    cdef godot_object *_owner = self.godot_owner
    cdef Variant ret
    api_core.godot_method_bind_ptrcall(bind_scripteditor_get_drag_data_fw,self.godot_owner,[NULL,],&ret)
  ...
  def  goto_line(self, line_number):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor_goto_line,self.godot_owner,[NULL,],NULL)
  def  open_script_create_dialog(self, base_namebase_path):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_scripteditor_open_script_create_dialog,self.godot_owner,[NULL,],NULL)
