...
############################Generated class###################################
cdef class RayCast(classes.Spatial.Spatial):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  def  add_exception(self,  classes.Object.Object node):
    ...
    api_core.godot_method_bind_ptrcall(bind_raycast_add_exception,self.godot_owner,args,NULL)
    hello('hallo2')
  def  add_exception_rid(self,  RID rid):
    ...
    args[0] = &rid._native
    api_core.godot_method_bind_ptrcall(bind_raycast_add_exception_rid,self.godot_owner,args,NULL)
    hello('hallo2')
  ...
  def  get_collision_mask_bit(self,  int bit):
    ...
    args[0] = &bit
    api_core.godot_method_bind_ptrcall(bind_raycast_get_collision_mask_bit,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  remove_exception(self,  classes.Object.Object node):
    ...
    args[0] = node.godot_owner
    api_core.godot_method_bind_ptrcall(bind_raycast_remove_exception,self.godot_owner,args,NULL)
    hello('hallo2')
  def  remove_exception_rid(self,  RID rid):
    ...
    args[0] = &rid._native
    api_core.godot_method_bind_ptrcall(bind_raycast_remove_exception_rid,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_cast_to(self,  Vector3 local_point):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &local_point._native
    api_core.godot_method_bind_ptrcall(bind_raycast_set_cast_to,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_collide_with_areas(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_raycast_set_collide_with_areas,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_collide_with_bodies(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_raycast_set_collide_with_bodies,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_collision_mask(self,  int mask):
    ...
    args[0] = &mask
    api_core.godot_method_bind_ptrcall(bind_raycast_set_collision_mask,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_collision_mask_bit(self,  int bit,  bool value):
    ...
    args[0] = &bit
    args[1] = &value
    api_core.godot_method_bind_ptrcall(bind_raycast_set_collision_mask_bit,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_enabled(self,  bool enabled):
    ...
    args[0] = &enabled
    api_core.godot_method_bind_ptrcall(bind_raycast_set_enabled,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_exclude_parent_body(self,  bool mask):
    ...
    args[0] = &mask
    api_core.godot_method_bind_ptrcall(bind_raycast_set_exclude_parent_body,self.godot_owner,args,NULL)
    hello('hallo2')
