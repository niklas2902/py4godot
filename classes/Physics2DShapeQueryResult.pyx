...
##################################Generated Methods#########################################
  ...
  def  get_result_object(self, idx):
    cdef godot_object *_owner = self.godot_owner
    cdef Object ret
    api_core.godot_method_bind_ptrcall(bind_physics2dshapequeryresult_get_result_object,self.godot_owner,[NULL,],&ret)
  def  get_result_object_id(self, idx):
    cdef godot_object *_owner = self.godot_owner
    cdef int ret
    api_core.godot_method_bind_ptrcall(bind_physics2dshapequeryresult_get_result_object_id,self.godot_owner,[NULL,],&ret)
  def  get_result_object_shape(self, idx):
    cdef godot_object *_owner = self.godot_owner
    cdef int ret
    api_core.godot_method_bind_ptrcall(bind_physics2dshapequeryresult_get_result_object_shape,self.godot_owner,[NULL,],&ret)
  def  get_result_rid(self, idx):
    cdef godot_object *_owner = self.godot_owner
    cdef RID ret
    api_core.godot_method_bind_ptrcall(bind_physics2dshapequeryresult_get_result_rid,self.godot_owner,[NULL,],&ret)
