...
############################Generated class###################################
cdef class RayShape2D(classes.Shape2D.Shape2D):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_length(self,  float length):
    ...
    args[0] = &length
    api_core.godot_method_bind_ptrcall(bind_rayshape2d_set_length,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_slips_on_slope(self,  bool active):
    ...
    args[0] = &active
    api_core.godot_method_bind_ptrcall(bind_rayshape2d_set_slips_on_slope,self.godot_owner,args,NULL)
    hello('hallo2')
