...
############################Generated class###################################
cdef class X509Certificate(classes.Resource.Resource):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  def  load(self,  String path):
    ...
    args[0] = &path._native
    api_core.godot_method_bind_ptrcall(bind_x509certificate_load,self.godot_owner,args,&ret)
    hello('hallo2')
  ...
  def  save(self,  String path):
    ...
    args[0] = &path._native
    api_core.godot_method_bind_ptrcall(bind_x509certificate_save,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
