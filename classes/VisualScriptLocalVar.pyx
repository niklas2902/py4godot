...
############################Generated class###################################
cdef class VisualScriptLocalVar(classes.VisualScriptNode.VisualScriptNode):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_var_name(self,  String name):
    ...
    args[0] = &name._native
    api_core.godot_method_bind_ptrcall(bind_visualscriptlocalvar_set_var_name,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_var_type(self,  int type):
    ...
    args[0] = &type
    api_core.godot_method_bind_ptrcall(bind_visualscriptlocalvar_set_var_type,self.godot_owner,args,NULL)
    hello('hallo2')
