...
##################################Generated Methods#########################################
  def  get_shadow_detail(self):
    ...
    cdef OmniLight_ShadowDetail* ret = NULL;
  ...
  def  get_shadow_mode(self):
    ...
    cdef OmniLight_ShadowMode* ret = NULL;

    api_core.godot_method_bind_ptrcall(bind_omnilight_get_shadow_mode,self.godot_owner,NULL,&ret)
    hello('hallo2')
    return dereference(ret)

  def  set_shadow_detail(self,  int detail):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &detail
    api_core.godot_method_bind_ptrcall(bind_omnilight_set_shadow_detail,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_shadow_mode(self,  int mode):
    ...
    args[0] = &mode
    api_core.godot_method_bind_ptrcall(bind_omnilight_set_shadow_mode,self.godot_owner,args,NULL)
    hello('hallo2')
