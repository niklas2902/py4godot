...
cimport classes.AudioStreamSample
...
############################Generated class###################################
cdef class AudioEffectRecord(classes.AudioEffect.AudioEffect):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  def  get_format(self):
    ...
    cdef classes.AudioStreamSample.AudioStreamSample_Format* ret = NULL;
  ...
  def  set_format(self,  int format):
    ...
    args[0] = &format
    api_core.godot_method_bind_ptrcall(bind_audioeffectrecord_set_format,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_recording_active(self,  bool record):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &record
    api_core.godot_method_bind_ptrcall(bind_audioeffectrecord_set_recording_active,self.godot_owner,args,NULL)
    hello('hallo2')
