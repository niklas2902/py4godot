...
##################################Generated Methods#########################################
  ...
  def  _dir_entered(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog__dir_entered,self.godot_owner,[NULL,],NULL)
  def  _file_entered(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog__file_entered,self.godot_owner,[NULL,],NULL)
  def  _filter_selected(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog__filter_selected,self.godot_owner,[NULL,],NULL)
  def  _go_up(self):
    cdef godot_object *_owner = self.godot_owner
  ...
  def  _select_drive(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog__select_drive,self.godot_owner,[NULL,],NULL)
  ...
  def  _tree_multi_selected(self, arg0arg1arg2):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog__tree_multi_selected,self.godot_owner,[NULL,],NULL)
  ...
  def  _unhandled_input(self, arg0):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog__unhandled_input,self.godot_owner,[NULL,],NULL)
  ...
  def  add_filter(self, filter):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog_add_filter,self.godot_owner,[NULL,],NULL)
  ...
  def  set_access(self, access):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog_set_access,self.godot_owner,[NULL,],NULL)
  def  set_current_dir(self, dir):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog_set_current_dir,self.godot_owner,[NULL,],NULL)
  def  set_current_file(self, file):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog_set_current_file,self.godot_owner,[NULL,],NULL)
  def  set_current_path(self, path):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog_set_current_path,self.godot_owner,[NULL,],NULL)
  def  set_filters(self, filters):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog_set_filters,self.godot_owner,[NULL,],NULL)
  def  set_mode(self, mode):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog_set_mode,self.godot_owner,[NULL,],NULL)
  def  set_mode_overrides_title(self, override):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog_set_mode_overrides_title,self.godot_owner,[NULL,],NULL)
  def  set_show_hidden_files(self, show):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_filedialog_set_show_hidden_files,self.godot_owner,[NULL,],NULL)
