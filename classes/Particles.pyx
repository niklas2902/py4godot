...
##################################Generated Methods#########################################
  ...
  def  get_draw_pass_mesh(self,  int pass_):
    ...
    args[0] = &pass_
    api_core.godot_method_bind_ptrcall(bind_particles_get_draw_pass_mesh,self.godot_owner,args,&ret)
    hello('hallo2')
  ...
  def  set_amount(self,  int amount):
    ...
    args[0] = &amount
    api_core.godot_method_bind_ptrcall(bind_particles_set_amount,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_draw_order(self,  int order):
    ...
    args[0] = &order
    api_core.godot_method_bind_ptrcall(bind_particles_set_draw_order,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_draw_pass_mesh(self,  int pass_,  classes.Mesh.Mesh mesh):
    cdef godot_object *_owner = self.godot_owner
    ...
    api_core.godot_method_bind_ptrcall(bind_particles_set_draw_pass_mesh,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_draw_passes(self,  int passes):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &passes
    api_core.godot_method_bind_ptrcall(bind_particles_set_draw_passes,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_emitting(self,  bool emitting):
    ...
    args[0] = &emitting
    api_core.godot_method_bind_ptrcall(bind_particles_set_emitting,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_explosiveness_ratio(self,  float ratio):
    ...
    args[0] = &ratio
    api_core.godot_method_bind_ptrcall(bind_particles_set_explosiveness_ratio,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_fixed_fps(self,  int fps):
    ...
    args[0] = &fps
    api_core.godot_method_bind_ptrcall(bind_particles_set_fixed_fps,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_fractional_delta(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_particles_set_fractional_delta,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_lifetime(self,  float secs):
    ...
    args[0] = &secs
    api_core.godot_method_bind_ptrcall(bind_particles_set_lifetime,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_one_shot(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_particles_set_one_shot,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_pre_process_time(self,  float secs):
    ...
    args[0] = &secs
    api_core.godot_method_bind_ptrcall(bind_particles_set_pre_process_time,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_process_material(self,  classes.Material.Material material):
    ...
    api_core.godot_method_bind_ptrcall(bind_particles_set_process_material,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_randomness_ratio(self,  float ratio):
    ...
    args[0] = &ratio
    api_core.godot_method_bind_ptrcall(bind_particles_set_randomness_ratio,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_speed_scale(self,  float scale):
    ...
    args[0] = &scale
    api_core.godot_method_bind_ptrcall(bind_particles_set_speed_scale,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_use_local_coordinates(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_particles_set_use_local_coordinates,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_visibility_aabb(self,  AABB aabb):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &aabb._native
    api_core.godot_method_bind_ptrcall(bind_particles_set_visibility_aabb,self.godot_owner,args,NULL)
    hello('hallo2')
