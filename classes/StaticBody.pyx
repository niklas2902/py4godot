...
############################Generated class###################################
cdef class StaticBody(classes.PhysicsBody.PhysicsBody):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_bounce(self,  float bounce):
    ...
    args[0] = &bounce
    api_core.godot_method_bind_ptrcall(bind_staticbody_set_bounce,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_constant_angular_velocity(self,  Vector3 vel):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &vel._native
    api_core.godot_method_bind_ptrcall(bind_staticbody_set_constant_angular_velocity,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_constant_linear_velocity(self,  Vector3 vel):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &vel._native
    api_core.godot_method_bind_ptrcall(bind_staticbody_set_constant_linear_velocity,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_friction(self,  float friction):
    ...
    args[0] = &friction
    api_core.godot_method_bind_ptrcall(bind_staticbody_set_friction,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_physics_material_override(self,  classes.PhysicsMaterial.PhysicsMaterial physics_material_override):
    ...
    api_core.godot_method_bind_ptrcall(bind_staticbody_set_physics_material_override,self.godot_owner,args,NULL)
    hello('hallo2')
