...
############################Generated class###################################
cdef class NavigationMeshInstance(classes.Spatial.Spatial):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  ...
  def  set_enabled(self,  bool enabled):
    ...
    args[0] = &enabled
    api_core.godot_method_bind_ptrcall(bind_navigationmeshinstance_set_enabled,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_navigation_mesh(self,  classes.NavigationMesh.NavigationMesh navmesh):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = navmesh.godot_owner
    api_core.godot_method_bind_ptrcall(bind_navigationmeshinstance_set_navigation_mesh,self.godot_owner,args,NULL)
    hello('hallo2')
