...
############################Generated class###################################
cdef class ProxyTexture(classes.Texture.Texture):
  def __init__(self):
    super().__init__()
...
##################################Generated Methods#########################################
  def  get_base(self):
    ...
    hello('hallo2')
  def  set_base(self,  classes.Texture.Texture base):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = base.godot_owner
    api_core.godot_method_bind_ptrcall(bind_proxytexture_set_base,self.godot_owner,args,NULL)
    hello('hallo2')
