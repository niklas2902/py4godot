...
##################################Generated Methods#########################################
  ...
  def  get_update_mode(self):
    cdef godot_object *_owner = self.godot_owner
    cdef ReflectionProbe::UpdateMode ret
  ...
  def  set_as_interior(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_reflectionprobe_set_as_interior,self.godot_owner,[NULL,],NULL)
  def  set_cull_mask(self, layers):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_reflectionprobe_set_cull_mask,self.godot_owner,[NULL,],NULL)
  def  set_enable_box_projection(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_reflectionprobe_set_enable_box_projection,self.godot_owner,[NULL,],NULL)
  def  set_enable_shadows(self, enable):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_reflectionprobe_set_enable_shadows,self.godot_owner,[NULL,],NULL)
  def  set_extents(self, extents):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_reflectionprobe_set_extents,self.godot_owner,[NULL,],NULL)
  def  set_intensity(self, intensity):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_reflectionprobe_set_intensity,self.godot_owner,[NULL,],NULL)
  def  set_interior_ambient(self, ambient):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_reflectionprobe_set_interior_ambient,self.godot_owner,[NULL,],NULL)
  def  set_interior_ambient_energy(self, ambient_energy):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_reflectionprobe_set_interior_ambient_energy,self.godot_owner,[NULL,],NULL)
  def  set_interior_ambient_probe_contribution(self, ambient_probe_contribution):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_reflectionprobe_set_interior_ambient_probe_contribution,self.godot_owner,[NULL,],NULL)
  def  set_max_distance(self, max_distance):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_reflectionprobe_set_max_distance,self.godot_owner,[NULL,],NULL)
  def  set_origin_offset(self, origin_offset):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_reflectionprobe_set_origin_offset,self.godot_owner,[NULL,],NULL)
  def  set_update_mode(self, mode):
    cdef godot_object *_owner = self.godot_owner
    api_core.godot_method_bind_ptrcall(bind_reflectionprobe_set_update_mode,self.godot_owner,[NULL,],NULL)
