...
##################################Generated Methods#########################################
  def  get_function(self):
    ...
    cdef VisualShaderNodeScalarDerivativeFunc_Function* ret = NULL;
  ...
  def  set_function(self,  int func):
    ...
    args[0] = &func
    api_core.godot_method_bind_ptrcall(bind_visualshadernodescalarderivativefunc_set_function,self.godot_owner,args,NULL)
    hello('hallo2')
