...
##################################Generated Methods#########################################
  ...
  def  _gui_input(self,  classes.InputEvent.InputEvent arg0):
    ...
    api_core.godot_method_bind_ptrcall(bind_textedit__gui_input,self.godot_owner,args,NULL)
    hello('hallo2')
  ...
  def  _scroll_moved(self,  float arg0):
    ...
    args[0] = &arg0
    api_core.godot_method_bind_ptrcall(bind_textedit__scroll_moved,self.godot_owner,args,NULL)
    hello('hallo2')
  ...
  def  _v_scroll_input(self):
    ...
    hello('hallo2')
  def  add_color_region(self,  String begin_key,  String end_key,  Color color,  bool line_only):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[4]

    args[0] = &begin_key._native
    args[1] = &end_key._native
    args[2] = &color._native
    args[3] = &line_only
    api_core.godot_method_bind_ptrcall(bind_textedit_add_color_region,self.godot_owner,args,NULL)
    hello('hallo2')
  def  add_keyword_color(self,  String keyword,  Color color):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[2]

    args[0] = &keyword._native
    args[1] = &color._native
    api_core.godot_method_bind_ptrcall(bind_textedit_add_keyword_color,self.godot_owner,args,NULL)
    hello('hallo2')
  def  can_fold(self,  int line):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &line
    api_core.godot_method_bind_ptrcall(bind_textedit_can_fold,self.godot_owner,args,&ret)
    hello('hallo2')
  ...
  def  cursor_set_blink_enabled(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_cursor_set_blink_enabled,self.godot_owner,args,NULL)
    hello('hallo2')
  def  cursor_set_blink_speed(self,  float blink_speed):
    ...
    args[0] = &blink_speed
    api_core.godot_method_bind_ptrcall(bind_textedit_cursor_set_blink_speed,self.godot_owner,args,NULL)
    hello('hallo2')
  def  cursor_set_block_mode(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_cursor_set_block_mode,self.godot_owner,args,NULL)
    hello('hallo2')
  def  cursor_set_column(self,  int column,  bool adjust_viewport):
    cdef godot_object *_owner = self.godot_owner
    ...
    api_core.godot_method_bind_ptrcall(bind_textedit_cursor_set_column,self.godot_owner,args,NULL)
    hello('hallo2')
  def  cursor_set_line(self,  int line,  bool adjust_viewport,  bool can_be_hidden,  int wrap_index):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[3] = &wrap_index
    api_core.godot_method_bind_ptrcall(bind_textedit_cursor_set_line,self.godot_owner,args,NULL)
    hello('hallo2')
  def  cut(self):
    cdef godot_object *_owner = self.godot_owner
  ...
  def  deselect(self):
    ...
    hello('hallo2')
  def  draw_minimap(self,  bool draw):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &draw
    api_core.godot_method_bind_ptrcall(bind_textedit_draw_minimap,self.godot_owner,args,NULL)
    hello('hallo2')
  def  fold_all_lines(self):
    ...
    hello('hallo2')
  def  fold_line(self,  int line):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &line
    api_core.godot_method_bind_ptrcall(bind_textedit_fold_line,self.godot_owner,args,NULL)
    hello('hallo2')
  ...
  def  get_keyword_color(self,  String keyword):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &keyword._native
    api_core.godot_method_bind_ptrcall(bind_textedit_get_keyword_color,self.godot_owner,args,&ret)
    hello('hallo2')
    return Color.new_static(dereference(ret))

  def  get_line(self,  int line):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &line
    api_core.godot_method_bind_ptrcall(bind_textedit_get_line,self.godot_owner,args,&ret)
    hello('hallo2')
  ...
  def  has_keyword_color(self,  String keyword):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &keyword._native
    api_core.godot_method_bind_ptrcall(bind_textedit_has_keyword_color,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)

  def  insert_text_at_cursor(self,  String text):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &text._native
    api_core.godot_method_bind_ptrcall(bind_textedit_insert_text_at_cursor,self.godot_owner,args,NULL)
    hello('hallo2')
  ...
  def  is_folded(self,  int line):
    ...
    args[0] = &line
    api_core.godot_method_bind_ptrcall(bind_textedit_is_folded,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  is_line_hidden(self,  int line):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &line
    api_core.godot_method_bind_ptrcall(bind_textedit_is_line_hidden,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  menu_option(self,  int option):
    ...
    args[0] = &option
    api_core.godot_method_bind_ptrcall(bind_textedit_menu_option,self.godot_owner,args,NULL)
    hello('hallo2')
  def  paste(self):
    cdef godot_object *_owner = self.godot_owner
  ...
  def  remove_breakpoints(self):
    ...
    hello('hallo2')
  def  search(self,  String key,  int flags,  int from_line,  int from_column):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[2] = &from_line
    args[3] = &from_column
    api_core.godot_method_bind_ptrcall(bind_textedit_search,self.godot_owner,args,&ret)
    hello('hallo2')
  def  select(self,  int from_line,  int from_column,  int to_line,  int to_column):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[2] = &to_line
    args[3] = &to_column
    api_core.godot_method_bind_ptrcall(bind_textedit_select,self.godot_owner,args,NULL)
    hello('hallo2')
  def  select_all(self):
    cdef godot_object *_owner = self.godot_owner
    ...
    hello('hallo2')
  def  set_breakpoint_gutter_enabled(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_breakpoint_gutter_enabled,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_context_menu_enabled(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_context_menu_enabled,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_draw_fold_gutter(self,  bool arg0):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &arg0
    api_core.godot_method_bind_ptrcall(bind_textedit_set_draw_fold_gutter,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_draw_spaces(self,  bool arg0):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &arg0
    api_core.godot_method_bind_ptrcall(bind_textedit_set_draw_spaces,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_draw_tabs(self,  bool arg0):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &arg0
    api_core.godot_method_bind_ptrcall(bind_textedit_set_draw_tabs,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_h_scroll(self,  int value):
    ...
    args[0] = &value
    api_core.godot_method_bind_ptrcall(bind_textedit_set_h_scroll,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_hiding_enabled(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_hiding_enabled,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_highlight_all_occurrences(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_highlight_all_occurrences,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_highlight_current_line(self,  bool enabled):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enabled
    api_core.godot_method_bind_ptrcall(bind_textedit_set_highlight_current_line,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_line_as_hidden(self,  int line,  bool enable):
    cdef godot_object *_owner = self.godot_owner
    ...
    args[0] = &line
    args[1] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_line_as_hidden,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_minimap_width(self,  int width):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &width
    api_core.godot_method_bind_ptrcall(bind_textedit_set_minimap_width,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_override_selected_font_color(self,  bool override):
    ...
    args[0] = &override
    api_core.godot_method_bind_ptrcall(bind_textedit_set_override_selected_font_color,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_readonly(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_readonly,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_right_click_moves_caret(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_right_click_moves_caret,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_selecting_enabled(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_selecting_enabled,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_shortcut_keys_enabled(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_shortcut_keys_enabled,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_show_line_numbers(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_show_line_numbers,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_smooth_scroll_enable(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_smooth_scroll_enable,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_syntax_coloring(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_syntax_coloring,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_text(self,  String text):
    ...
    args[0] = &text._native
    api_core.godot_method_bind_ptrcall(bind_textedit_set_text,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_v_scroll(self,  float value):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &value
    api_core.godot_method_bind_ptrcall(bind_textedit_set_v_scroll,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_v_scroll_speed(self,  float speed):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &speed
    api_core.godot_method_bind_ptrcall(bind_textedit_set_v_scroll_speed,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_wrap_enabled(self,  bool enable):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_textedit_set_wrap_enabled,self.godot_owner,args,NULL)
    hello('hallo2')
  def  toggle_fold_line(self,  int line):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &line
    api_core.godot_method_bind_ptrcall(bind_textedit_toggle_fold_line,self.godot_owner,args,NULL)
    hello('hallo2')
  def  undo(self):
    cdef godot_object *_owner = self.godot_owner
    ...
    hello('hallo2')
  def  unfold_line(self,  int line):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &line
    api_core.godot_method_bind_ptrcall(bind_textedit_unfold_line,self.godot_owner,args,NULL)
    hello('hallo2')
