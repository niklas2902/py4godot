...
##################################Generated Methods#########################################
  ...
  def  convert_from_particles(self,  classes.Node.Node particles):
    ...
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_convert_from_particles,self.godot_owner,args,NULL)
    hello('hallo2')
  def  get_amount(self):
    cdef godot_object *_owner = self.godot_owner
  ...
  def  get_param(self,  int param):
    ...
    args[0] = &param
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_get_param,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  get_param_curve(self,  int param):
    ...
    args[0] = &param
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_get_param_curve,self.godot_owner,args,&ret)
    hello('hallo2')
  def  get_param_randomness(self,  int param):
    ...
    args[0] = &param
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_get_param_randomness,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  get_particle_flag(self,  int flag):
    ...
    args[0] = &flag
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_get_particle_flag,self.godot_owner,args,&ret)
    hello('hallo2')
    return dereference(ret)
  ...
  def  set_amount(self,  int amount):
    ...
    args[0] = &amount
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_amount,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_color(self,  Color color):
    ...
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_color,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_color_ramp(self,  classes.Gradient.Gradient ramp):
    ...
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_color_ramp,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_direction(self,  Vector3 direction):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &direction._native
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_direction,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_draw_order(self,  int order):
    ...
    args[0] = &order
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_draw_order,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_emission_box_extents(self,  Vector3 extents):
    ...
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_emission_box_extents,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_emission_colors(self,  PoolColorArray array):
    ...
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_emission_colors,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_emission_normals(self,  PoolVector3Array array):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &array._native
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_emission_normals,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_emission_points(self,  PoolVector3Array array):
    cdef godot_object *_owner = self.godot_owner

    cdef void *args[1]

    args[0] = &array._native
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_emission_points,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_emission_shape(self,  int shape):
    ...
    args[0] = &shape
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_emission_shape,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_emission_sphere_radius(self,  float radius):
    ...
    args[0] = &radius
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_emission_sphere_radius,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_emitting(self,  bool emitting):
    ...
    args[0] = &emitting
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_emitting,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_explosiveness_ratio(self,  float ratio):
    ...
    args[0] = &ratio
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_explosiveness_ratio,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_fixed_fps(self,  int fps):
    ...
    args[0] = &fps
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_fixed_fps,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_flatness(self,  float amount):
    ...
    args[0] = &amount
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_flatness,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_fractional_delta(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_fractional_delta,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_gravity(self,  Vector3 accel_vec):
    ...
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_gravity,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_lifetime(self,  float secs):
    ...
    args[0] = &secs
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_lifetime,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_lifetime_randomness(self,  float random):
    ...
    args[0] = &random
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_lifetime_randomness,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_mesh(self,  classes.Mesh.Mesh mesh):
    ...
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_mesh,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_one_shot(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_one_shot,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_param(self,  int param,  float value):
    ...
    args[0] = &param
    args[1] = &value
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_param,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_param_curve(self,  int param,  classes.Curve.Curve curve):
    ...
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_param_curve,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_param_randomness(self,  int param,  float randomness):
    ...
    args[0] = &param
    args[1] = &randomness
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_param_randomness,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_particle_flag(self,  int flag,  bool enable):
    ...
    args[0] = &flag
    args[1] = &enable
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_particle_flag,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_pre_process_time(self,  float secs):
    ...
    args[0] = &secs
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_pre_process_time,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_randomness_ratio(self,  float ratio):
    ...
    args[0] = &ratio
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_randomness_ratio,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_speed_scale(self,  float scale):
    ...
    args[0] = &scale
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_speed_scale,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_spread(self,  float degrees):
    ...
    args[0] = &degrees
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_spread,self.godot_owner,args,NULL)
    hello('hallo2')
  def  set_use_local_coordinates(self,  bool enable):
    ...
    args[0] = &enable
    api_core.godot_method_bind_ptrcall(bind_cpuparticles_set_use_local_coordinates,self.godot_owner,args,NULL)
    hello('hallo2')
