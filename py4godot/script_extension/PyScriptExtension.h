...
public:
  ...
  void update_instance_data(InstanceData *gd_instance,
                            PyObject *instance); // self-defined
  void apply_code();
  ...
  void _has_property_default_value(StringName &property,
                                   GDExtensionTypePtr res);
  void _get_property_default_value(StringName &property,
                                   GDExtensionTypePtr res);
  ...
  void _set_path_cache(String &path, GDExtensionTypePtr res);
