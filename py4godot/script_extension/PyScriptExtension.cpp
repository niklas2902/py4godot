...
void handle_python_error(PyObject *ptype, PyObject *pvalue,
                         PyObject *ptraceback) {
  // Retrieve the error type and value (already handled in your code)
  PyObject *str_exc_type =
      PyObject_Repr(pvalue); // Exception as a unicode object
...
void init_pluginscript_api() {
  ...
  #ifdef AUTO_INSTALL
  std::string install_dependencies = std::string(current_dir) + "/" +
  python_home_narrow + "/python.exe addons/py4godot/install_dependencies.py";
  system(install_dependencies.c_str());
  #endif
  */
  Py_SetProgramName(L"python");
  Py_SetPythonHome(PYTHONHOME);
  // Initialize interpreter but skip initialization registration of signal
  // handlers
  Py_InitializeEx(0);
  ...
  std::string pythonCode = "import sys\n"
                           ...
                           "''')\n"
                           "sys.path.append(r'''" +
                           std::string{cwd} + std::string{PYTHONPATH} + "''')";
  ...
  PyObject *result =
      PyRun_String(pythonCode.c_str(), Py_file_input, global_dict, global_dict);
...
void PyScriptExtension::init_signals(PyObject *instance) {
  ...
  for (auto &signal_description_ptr : transfer_object.signals) {
    signals.push_back(std::make_shared<godot::Dictionary>(
        *build_signal(*signal_description_ptr)));
  }
...
void free_instance_script(void *p_userdata,
...
void PyScriptExtension::_get_class_item_path(GDExtensionTypePtr res) {
  ...
  if (transfer_object.icon_path != std::string{}) {
    functions::get_string_new_with_utf8_chars()(
        res, transfer_object.icon_path.c_str());
  }
}
...
void PyScriptExtension::_inherits_script(Script *script,
...
void PyScriptExtension::_get_instance_base_type(GDExtensionTypePtr res) {
  ...
  functions::get_string_new_with_utf8_chars()(&gd_string.godot_owner,
                                              type.c_str());

  auto variant_type =
      GDExtensionVariantType::GDEXTENSION_VARIANT_TYPE_STRING_NAME;
  GDExtensionPtrConstructor constructor =
      functions::get_variant_get_ptr_constructor()(variant_type, 2);
  GDExtensionTypePtr _args[1];
  _args[0] = &gd_string.godot_owner;
  constructor(((void **)res), _args);
}

void PyScriptExtension::update_instance_data(InstanceData *gd_instance,
                                             PyObject *instance) {
  ...
  for (auto &default_value : transfer_object.default_values) {
    ...
    if (std::find(gd_instance->already_set_properties.begin(),
                  gd_instance->already_set_properties.end(),
                  string_property_name) ==
        gd_instance->already_set_properties.end()) {

      set_default_val(
          gd_instance->owner,
          PyUnicode_FromStringAndSize(c_property_name, property_name.length()),
          default_value);
...
void PyScriptExtension::_instance_create(Object &for_object,
                                         GDExtensionTypePtr res) {
  ...
  ScriptDatabase::instance()->register_script(for_object.get_instance_id(),
                                              gd_instance->owner);
  instance_ptr = functions::get_script_instance_create()(&(gd_instance->info),
                                                         gd_instance);
...
void PyScriptExtension::_placeholder_instance_create(Object &for_object,
                                                     GDExtensionTypePtr res) {
...
void PyScriptExtension::_has_method(StringName &method,
                                    GDExtensionTypePtr res) {
  print_error("_has_method");
  *static_cast<bool *>(res) = false;
}
void PyScriptExtension::_get_method_info(StringName &method,
                                         GDExtensionTypePtr res) {
...
void PyScriptExtension::_has_script_signal(StringName &signal,
                                           GDExtensionTypePtr res) {
...
void PyScriptExtension::_get_script_signal_list(GDExtensionTypePtr res) {
  ...
  for (auto &signal_description_ptr : transfer_object.signals) {
    ...
    auto constructor = functions::get_get_variant_from_type_constructor()(
...
void PyScriptExtension::_has_property_default_value(StringName &property,
                                                    GDExtensionTypePtr res) {
  print_error("_has_property_default_value");
}
void PyScriptExtension::_get_property_default_value(StringName &property,
                                                    GDExtensionTypePtr res) {
...
void PyScriptExtension::_get_member_line(StringName &member,
                                         GDExtensionTypePtr res) {
...
void PyScriptExtension::_is_placeholder_fallback_enabled(
    GDExtensionTypePtr res) {
  *static_cast<bool *>(res) = false;
}
...
*/
namespace script {
void call_virtual_func__editor_can_reload_from_file(
    GDExtensionClassInstancePtr p_instance,
...
void call_virtual_func__can_instantiate(GDExtensionClassInstancePtr p_instance,
...
void call_virtual_func__is_abstract(GDExtensionClassInstancePtr p_instance,
                                    const GDExtensionConstTypePtr *p_args,
                                    GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_class_item__path(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_base_script(GDExtensionClassInstancePtr p_instance,
                                        const GDExtensionConstTypePtr *p_args,
                                        GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_global_name(GDExtensionClassInstancePtr p_instance,
                                        const GDExtensionConstTypePtr *p_args,
                                        GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__inherits_script(GDExtensionClassInstancePtr p_instance,
                                        const GDExtensionConstTypePtr *p_args,
                                        GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_instance_base_type(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__instance_create(GDExtensionClassInstancePtr p_instance,
                                        const GDExtensionConstTypePtr *p_args,
                                        GDExtensionTypePtr r_ret) {

  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
  Object args0 =
      Object::new_static(const_cast<GDExtensionStringPtr>(p_args[0]));
...
void call_virtual_func__placeholder_instance_create(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
...
void call_virtual_func__instance_has(GDExtensionClassInstancePtr p_instance,
                                     const GDExtensionConstTypePtr *p_args,
                                     GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
  Object args0 =
...
void call_virtual_func__has_source_code(GDExtensionClassInstancePtr p_instance,
                                        const GDExtensionConstTypePtr *p_args,
                                        GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_doc_class_name(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__has_static_method(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_source_code(GDExtensionClassInstancePtr p_instance,
                                        const GDExtensionConstTypePtr *p_args,
                                        GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__set_source_code(GDExtensionClassInstancePtr p_instance,
                                        const GDExtensionConstTypePtr *p_args,
                                        GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__reload(GDExtensionClassInstancePtr p_instance,
                               const GDExtensionConstTypePtr *p_args,
                               GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_documentation(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__has_method(GDExtensionClassInstancePtr p_instance,
                                   const GDExtensionConstTypePtr *p_args,
                                   GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
  StringName args0 =
...
void call_virtual_func__get_method_info(GDExtensionClassInstancePtr p_instance,
                                        const GDExtensionConstTypePtr *p_args,
                                        GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
  StringName args0 =
...
void call_virtual_func__is_tool(GDExtensionClassInstancePtr p_instance,
                                const GDExtensionConstTypePtr *p_args,
                                GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__is_valid(GDExtensionClassInstancePtr p_instance,
                                 const GDExtensionConstTypePtr *p_args,
                                 GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_language(GDExtensionClassInstancePtr p_instance,
                                     const GDExtensionConstTypePtr *p_args,
                                     GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__has_script_signal(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
  StringName args0 =
...
void call_virtual_func__get_script_signal_list(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__has_property_default_value(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
  StringName args0 =
...
void call_virtual_func__get_property_default_value(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
  StringName args0 =
...
void call_virtual_func__update_exports(GDExtensionClassInstancePtr p_instance,
                                       const GDExtensionConstTypePtr *p_args,
                                       GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_script_method_list(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_script_property_list(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_member_line(GDExtensionClassInstancePtr p_instance,
                                        const GDExtensionConstTypePtr *p_args,
                                        GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
  StringName args0 =
...
void call_virtual_func__set_path_cache(GDExtensionClassInstancePtr p_instance,
                                       const GDExtensionConstTypePtr *p_args,
                                       GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
  String args0 =
...
void call_virtual_func__get_constants(GDExtensionClassInstancePtr p_instance,
                                      const GDExtensionConstTypePtr *p_args,
                                      GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_members(GDExtensionClassInstancePtr p_instance,
                                    const GDExtensionConstTypePtr *p_args,
                                    GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__is_placeholder_fallback_enabled(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
void call_virtual_func__get_rpc_config(GDExtensionClassInstancePtr p_instance,
                                       const GDExtensionConstTypePtr *p_args,
                                       GDExtensionTypePtr r_ret) {
  PyScriptExtension *pylanguage = static_cast<PyScriptExtension *>(p_instance);
...
get_virtual_script(void *p_userdata, GDExtensionConstStringNamePtr p_name) {
  ...
  if (string_names_equal_script(script::func_name__editor_can_reload_from_file,
                                name)) {
    return script::call_virtual_func__editor_can_reload_from_file;
  }

  else if (string_names_equal_script(script::func_name__can_instantiate,
                                     name)) {
    return script::call_virtual_func__can_instantiate;
  }

  else if (string_names_equal_script(script::func_name__get_base_script,
                                     name)) {
    return script::call_virtual_func__get_base_script;
  }

  else if (string_names_equal_script(script::func_name__get_global_name,
                                     name)) {
    return script::call_virtual_func__get_global_name;
  }

  else if (string_names_equal_script(script::func_name__inherits_script,
                                     name)) {
    return script::call_virtual_func__inherits_script;
  }

  else if (string_names_equal_script(script::func_name__get_instance_base_type,
                                     name)) {
    return script::call_virtual_func__get_instance_base_type;
  }

  else if (string_names_equal_script(script::func_name__instance_create,
                                     name)) {
    return script::call_virtual_func__instance_create;
  }

  else if (string_names_equal_script(
               script::func_name__placeholder_instance_create, name)) {
  ...
  else if (string_names_equal_script(script::func_name__has_source_code,
                                     name)) {
    return script::call_virtual_func__has_source_code;
  }

  else if (string_names_equal_script(script::func_name__get_doc_class_name,
                                     name)) {
    return script::call_virtual_func__get_doc_class_name;
  }

  else if (string_names_equal_script(script::func_name__has_static_method,
                                     name)) {
    return script::call_virtual_func__has_static_method;
  }

  else if (string_names_equal_script(script::func_name__get_source_code,
                                     name)) {
    return script::call_virtual_func__get_source_code;
  }

  else if (string_names_equal_script(script::func_name__set_source_code,
                                     name)) {
  ...
  else if (string_names_equal_script(script::func_name__get_documentation,
                                     name)) {
  ...
  else if (string_names_equal_script(script::func_name__get_method_info,
                                     name)) {
  ...
  else if (string_names_equal_script(script::func_name__has_script_signal,
                                     name)) {
    return script::call_virtual_func__has_script_signal;
  }

  else if (string_names_equal_script(script::func_name__get_script_signal_list,
                                     name)) {
    return script::call_virtual_func__get_script_signal_list;
  }

  else if (string_names_equal_script(
               script::func_name__has_property_default_value, name)) {
    return script::call_virtual_func__has_property_default_value;
  }

  else if (string_names_equal_script(
               script::func_name__get_property_default_value, name)) {
  ...
  else if (string_names_equal_script(script::func_name__get_script_method_list,
                                     name)) {
    return script::call_virtual_func__get_script_method_list;
  }

  else if (string_names_equal_script(
               script::func_name__get_script_property_list, name)) {
    return script::call_virtual_func__get_script_property_list;
  }

  else if (string_names_equal_script(script::func_name__get_member_line,
                                     name)) {
    ...
    return script::call_virtual_func__get_members;
               ...
               script::func_name__is_placeholder_fallback_enabled, name)) {
  ...
  else if (string_names_equal_script(script::func_name__get_class_item_path,
                                     name)) {
...
void init_func_names_script() {
  script::func_name__editor_can_reload_from_file =
      c_string_to_string_name("_editor_can_reload_from_file");
  script::func_name__can_instantiate =
      c_string_to_string_name("_can_instantiate");
  script::func_name__is_abstract = c_string_to_string_name("_is_abstract");
  script::func_name__get_base_script =
      c_string_to_string_name("_get_base_script");
  script::func_name__get_global_name =
      c_string_to_string_name("_get_global_name");
  script::func_name__inherits_script =
      c_string_to_string_name("_inherits_script");
  script::func_name__get_instance_base_type =
      c_string_to_string_name("_get_instance_base_type");
  script::func_name__instance_create =
      c_string_to_string_name("_instance_create");
  script::func_name__placeholder_instance_create =
      c_string_to_string_name("_placeholder_instance_create");
  script::func_name__instance_has = c_string_to_string_name("_instance_has");
  script::func_name__has_source_code =
      c_string_to_string_name("_has_source_code");
  script::func_name__get_doc_class_name =
      c_string_to_string_name("_get_doc_class_name");
  script::func_name__has_static_method =
      c_string_to_string_name("_has_static_method");
  script::func_name__get_source_code =
      c_string_to_string_name("_get_source_code");
  script::func_name__set_source_code =
      c_string_to_string_name("_set_source_code");
  script::func_name__reload = c_string_to_string_name("_reload");
  script::func_name__get_documentation =
      c_string_to_string_name("_get_documentation");
  script::func_name__has_method = c_string_to_string_name("_has_method");
  script::func_name__get_method_info =
      c_string_to_string_name("_get_method_info");
  ...
  script::func_name__has_script_signal =
      c_string_to_string_name("_has_script_signal");
  script::func_name__get_script_signal_list =
      c_string_to_string_name("_get_script_signal_list");
  script::func_name__has_property_default_value =
      c_string_to_string_name("_has_property_default_value");
  script::func_name__get_property_default_value =
      c_string_to_string_name("_get_property_default_value");
  script::func_name__update_exports =
      c_string_to_string_name("_update_exports");
  script::func_name__get_script_method_list =
      c_string_to_string_name("_get_script_method_list");
  script::func_name__get_script_property_list =
      c_string_to_string_name("_get_script_property_list");
  script::func_name__get_member_line =
      c_string_to_string_name("_get_member_line");
  script::func_name__set_path_cache =
      c_string_to_string_name("_set_path_cache");
  ...
  script::func_name__is_placeholder_fallback_enabled =
      c_string_to_string_name("_is_placeholder_fallback_enabled");
  script::func_name__get_class_item_path =
      c_string_to_string_name("_get_class_icon_path");
}

void register_class_script() {
  init_func_names_script();
  init_pluginscript_api();
  operator_equal_string_namescript =
  ...
  functions::get_classdb_register_extension_class()(
      _library, &class_name.godot_owner, &parent_class_name.godot_owner,
      creation_info);
}