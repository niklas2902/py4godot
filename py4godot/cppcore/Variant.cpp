...
void Variant::init_variant() {
  ...
  if (PyErr_Occurred()) {
    ...
    PyObject *pyStr =
        PyUnicode_AsEncodedString(str_exc_type, "utf-8", "Error ~");
...
Variant::Variant() {
  /*int dummy = 0;
  auto constructor =
  get_interface()->get_variant_from_type_constructor(GDExtensionVariantType::GDEXTENSION_VARIANT_TYPE_INT);
...
PyObject *Variant::create_vector3() {
  ...
  constructor(&vector->native_struct, native_ptr);
...
PyObject *Variant::create_rect2i() {
  ...
  string->shouldBeDeleted = false;
  constructor(&string->native_struct, native_ptr);
...
static void unreference(Object &val) {
  ...
  GDExtensionMethodBindPtr method_bind =
      functions::get_classdb_get_method_bind()(
          &_class_name.godot_owner, &_method_name.godot_owner, 2240911060);
  assert(method_bind != nullptr);

  functions::get_object_method_bind_ptrcall()(method_bind, val.godot_owner,
                                              _args, &_ret);
}
...
void Variant::init_from_py_object_native_ptr(PyObject *object,
...
void Variant::construct_Rect2i(PyObject *object) {
  ...
  constructor(native_ptr, &converted_val->native_struct);
...
void Variant::construct_py_string(PyObject *object) {
  char *c_str = (char *)PyUnicode_AsUTF8(object);
