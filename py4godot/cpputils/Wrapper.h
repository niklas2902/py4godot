...
public:
  ...
  Wrapper() { shouldBeDeleted = false; }
  void set_godot_owner(GDExtensionObjectPtr owner) { godot_owner = owner; }

  GDExtensionObjectPtr get_godot_owner() { return godot_owner; }

  void copy_owner(Wrapper *ptr) { this->godot_owner = ptr->godot_owner; }
