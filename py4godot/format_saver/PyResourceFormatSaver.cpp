...
void free_instance_saver(void *p_userdata,
...
void PyResourceFormatSaver::_save(Resource &resource, String &path, int flags,
...
void PyResourceFormatSaver::_set_uid(String &path, int uid,
                                     GDExtensionTypePtr res) {
  print_error("_set_uid");
}
void PyResourceFormatSaver::_recognize(Resource &resource,
                                       GDExtensionTypePtr res) {
  print_error("_recognize");
  bool recognized = resource.godot_owner != nullptr;
  *reinterpret_cast<bool *>(res) = recognized;
}
void PyResourceFormatSaver::_get_recognized_extensions(Resource &resource,
                                                       GDExtensionTypePtr res) {
...
void PyResourceFormatSaver::_recognize_path(Resource &resource, String &path,
                                            GDExtensionTypePtr res) {
...
#pragma region : saver
namespace saver {
static void call_virtual_func__save(GDExtensionClassInstancePtr p_instance,
                                    const GDExtensionConstTypePtr *p_args,
                                    GDExtensionTypePtr r_ret) {
  PyResourceFormatSaver *pylanguage =
      static_cast<PyResourceFormatSaver *>(p_instance);
  Resource args0 =
      Resource::new_static(functions::get_ref_get_object()(p_args[0]));
...
static void call_virtual_func__set_uid(GDExtensionClassInstancePtr p_instance,
                                       const GDExtensionConstTypePtr *p_args,
                                       GDExtensionTypePtr r_ret) {
  PyResourceFormatSaver *pylanguage =
      static_cast<PyResourceFormatSaver *>(p_instance);
...
static void call_virtual_func__recognize(GDExtensionClassInstancePtr p_instance,
                                         const GDExtensionConstTypePtr *p_args,
                                         GDExtensionTypePtr r_ret) {
  PyResourceFormatSaver *pylanguage =
      static_cast<PyResourceFormatSaver *>(p_instance);
...
static void call_virtual_func__get_recognized_extensions(
    GDExtensionClassInstancePtr p_instance,
...
static void
call_virtual_func__recognize_path(GDExtensionClassInstancePtr p_instance,
                                  const GDExtensionConstTypePtr *p_args,
                                  GDExtensionTypePtr r_ret) {
  PyResourceFormatSaver *pylanguage =
      static_cast<PyResourceFormatSaver *>(p_instance);
...
get_virtual_saver(void *p_userdata, GDExtensionConstStringNamePtr p_name) {
  ...
  else if (string_names_equal_save(saver::func_name__get_recognized_extensions,
                                   name)) {
...
void init_func_names_save() {
  ...
  saver::func_name__get_recognized_extensions =
...
void register_class_saver() {
  ...
  operator_equal_string_name_save =
