...
bool string_names_equal_loader(StringName &left, StringName &right) {
  ...
  uint8_t ret;
  operator_equal_string_name_loader(&left.godot_owner, &right.godot_owner,
                                    &ret);
  return ret != 0;
}
PyResourceFormatLoader *
PyResourceFormatLoader::constructor(PyLanguage *language) {
...
void free_instance_loader(void *p_userdata,
...
void PyResourceFormatLoader::_get_recognized_extensions(
    GDExtensionTypePtr res) {
  print_error("_get_recognized_extensions");
  auto py = c_string_to_string("py");
  add_string_to_array(res, py);
}
void PyResourceFormatLoader::_recognize_path(String &path, StringName &type,
                                             GDExtensionTypePtr res) {
  ...
  bool can_be_loaded =
      path.ends_with(py) || path.ends_with(pyw) || path.ends_with(pyi);
  *reinterpret_cast<void **>(res) = reinterpret_cast<void *>(can_be_loaded);
}
void PyResourceFormatLoader::_handles_type(StringName &type,
                                           GDExtensionTypePtr res) {
...
void PyResourceFormatLoader::_get_resource_type(String &path,
                                                GDExtensionTypePtr res) {
...
void PyResourceFormatLoader::_get_resource_script_class(
    String &path, GDExtensionTypePtr res) {
  print_error("_get_resource_script_class");
}
void PyResourceFormatLoader::_get_resource_uid(String &path,
                                               GDExtensionTypePtr res) {
...
void PyResourceFormatLoader::_get_dependencies(String &path, bool add_types,
                                               GDExtensionTypePtr res) {
  print_error("_get_dependencies");
}
void PyResourceFormatLoader::_rename_dependencies(String &path,
                                                  Dictionary &renames,
                                                  GDExtensionTypePtr res) {
...
void PyResourceFormatLoader::_get_classes_used(String &path,
                                               GDExtensionTypePtr res) {
  print_error("_get_classes_used");
}
void PyResourceFormatLoader::_load(String &path, String &original_path,
                                   bool use_sub_threads, int cache_mode,
                                   GDExtensionTypePtr res) {
  ...
  constructor_func = functions::get_get_variant_from_type_constructor()(
...
void call_virtual_func__get_recognized_extensions(
  ...
  PyResourceFormatLoader *pylanguage =
      static_cast<PyResourceFormatLoader *>(p_instance);
  pylanguage->_get_recognized_extensions(r_ret);
}

StringName func_name__get_recognized_extensions;

void call_virtual_func__recognize_path(GDExtensionClassInstancePtr p_instance,
  ...
  StringName args1 = StringName::new_static(
...
void call_virtual_func__handles_type(GDExtensionClassInstancePtr p_instance,
                                     const GDExtensionConstTypePtr *p_args,
                                     GDExtensionTypePtr r_ret) {
  PyResourceFormatLoader *pylanguage =
      static_cast<PyResourceFormatLoader *>(p_instance);
...
void call_virtual_func__get_resource_type(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyResourceFormatLoader *pylanguage =
      static_cast<PyResourceFormatLoader *>(p_instance);
...
void call_virtual_func__get_resource_script_class(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyResourceFormatLoader *pylanguage =
      static_cast<PyResourceFormatLoader *>(p_instance);
...
void call_virtual_func__get_resource_uid(GDExtensionClassInstancePtr p_instance,
                                         const GDExtensionConstTypePtr *p_args,
                                         GDExtensionTypePtr r_ret) {
  PyResourceFormatLoader *pylanguage =
      static_cast<PyResourceFormatLoader *>(p_instance);
...
void call_virtual_func__get_dependencies(GDExtensionClassInstancePtr p_instance,
                                         const GDExtensionConstTypePtr *p_args,
                                         GDExtensionTypePtr r_ret) {
  PyResourceFormatLoader *pylanguage =
      static_cast<PyResourceFormatLoader *>(p_instance);
...
void call_virtual_func__rename_dependencies(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyResourceFormatLoader *pylanguage =
      static_cast<PyResourceFormatLoader *>(p_instance);
  String args0 = String::new_static(
      *((void **)const_cast<GDExtensionStringPtr>(p_args[0])));
  Dictionary args1 = Dictionary::new_static(
      *((void **)const_cast<GDExtensionStringPtr>(p_args[1])));
...
void call_virtual_func__exists(GDExtensionClassInstancePtr p_instance,
                               const GDExtensionConstTypePtr *p_args,
                               GDExtensionTypePtr r_ret) {
  PyResourceFormatLoader *pylanguage =
      static_cast<PyResourceFormatLoader *>(p_instance);
...
void call_virtual_func__get_classes_used(GDExtensionClassInstancePtr p_instance,
                                         const GDExtensionConstTypePtr *p_args,
                                         GDExtensionTypePtr r_ret) {
  PyResourceFormatLoader *pylanguage =
      static_cast<PyResourceFormatLoader *>(p_instance);
...
void call_virtual_func__load(GDExtensionClassInstancePtr p_instance,
                             const GDExtensionConstTypePtr *p_args,
                             GDExtensionTypePtr r_ret) {
  PyResourceFormatLoader *pylanguage =
      static_cast<PyResourceFormatLoader *>(p_instance);
...
get_virtual_loader(void *p_userdata, GDExtensionConstStringNamePtr p_name) {
  ...
  if (string_names_equal_loader(loader::func_name__get_recognized_extensions,
                                name)) {
  ...
  else if (string_names_equal_loader(loader::func_name__get_resource_type,
                                     name)) {
    return loader::call_virtual_func__get_resource_type;
  }

  else if (string_names_equal_loader(
               loader::func_name__get_resource_script_class, name)) {
    return loader::call_virtual_func__get_resource_script_class;
  }

  else if (string_names_equal_loader(loader::func_name__get_resource_uid,
                                     name)) {
    return loader::call_virtual_func__get_resource_uid;
  }

  else if (string_names_equal_loader(loader::func_name__get_dependencies,
                                     name)) {
    return loader::call_virtual_func__get_dependencies;
  }

  else if (string_names_equal_loader(loader::func_name__rename_dependencies,
                                     name)) {
  ...
  else if (string_names_equal_loader(loader::func_name__get_classes_used,
                                     name)) {
...
void init_func_names_loader() {
  ...
  loader::func_name__get_recognized_extensions =
      c_string_to_string_name("_get_recognized_extensions");
  loader::func_name__recognize_path =
      c_string_to_string_name("_recognize_path");
  loader::func_name__handles_type = c_string_to_string_name("_handles_type");
  loader::func_name__get_resource_type =
      c_string_to_string_name("_get_resource_type");
  loader::func_name__get_resource_script_class =
      c_string_to_string_name("_get_resource_script_class");
  loader::func_name__get_resource_uid =
      c_string_to_string_name("_get_resource_uid");
  loader::func_name__get_dependencies =
      c_string_to_string_name("_get_dependencies");
  loader::func_name__rename_dependencies =
      c_string_to_string_name("_rename_dependencies");
  loader::func_name__exists = c_string_to_string_name("_exists");
  loader::func_name__get_classes_used =
      c_string_to_string_name("_get_classes_used");
  loader::func_name__load = c_string_to_string_name("_load");
}

void register_class_loader() {
  init_func_names_loader();
  operator_equal_string_name_loader =
  ...
  StringName parent_class_name =
      c_string_to_string_name("ResourceFormatLoader");
  class_name.shouldBeDeleted = false;
