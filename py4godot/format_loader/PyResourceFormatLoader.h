...
public:
  ...
  void _rename_dependencies(String &path, Dictionary &renames,
  ...
  void _load(String &path, String &original_path, bool use_sub_threads,
             int cache_mode, GDExtensionTypePtr res);
};
} // namespace godot
