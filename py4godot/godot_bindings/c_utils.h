...
int index;
void set_gdnative_ptr(GDExtensionTypePtr *a, GDExtensionTypePtr b) { *a = b; }
...
void create_variant_bool(GDExtensionInterface *interface_ptr,
                         GDExtensionVariantPtr variant_ptr, uint8_t val) {
  ...
  GDExtensionVariantFromTypeConstructorFunc constructor_func_valid =
      interface_ptr->get_variant_from_type_constructor(
          GDEXTENSION_VARIANT_TYPE_BOOL);
  constructor_func_valid(variant_ptr, &val_to_set);
}

char *gd_string_c_string(GDExtensionInterface *interface_ptr,
                         GDExtensionConstStringPtr string_ptr, int length) {
...
void create_native_ptr_from_ptr(GDExtensionInterface *interface_ptr,
                                void **from_ptr) {
  //* (from_ptr) =  interface_ptr->mem_alloc(8);
}

void run_constructor(GDExtensionPtrConstructor constructor, void **gd_owner,
                     void **args) {
...
void exec_method(GDExtensionInterface *interface_ptr,
                 GDExtensionMethodBindPtr method_bind, void *gd_owner,
                 void **args, void **ret) {
  interface_ptr->object_method_bind_ptrcall(method_bind, gd_owner, args,
                                            &ptr_wrapper_array[index].val);
