...
def get_viewport(Node node):
    ...
    _ret.Viewport_internal_class = node.Node_internal_class.py_get_viewport()
...
def get_window(Node node):
    ...
    _ret.Window_internal_class = node.Node_internal_class.py_get_window()
...
def get_tree(Node node):
    ...
    _ret.SceneTree_internal_class = node.Node_internal_class.py_get_tree()
