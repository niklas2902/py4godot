...
public:
  ...
  void _make_template(String &template_, String &class_name,
                      String &base_class_name, GDExtensionTypePtr res);
  void _get_built_in_templates(StringName &object, GDExtensionTypePtr res);
  void _is_using_templates(GDExtensionTypePtr res);
  void _validate(String &script, String &path, bool validate_functions,
                 bool validate_errors, bool validate_warnings,
                 bool validate_safe_lines, GDExtensionTypePtr res);
  ...
  void _find_function(String &class_name, String &function_name,
                      GDExtensionTypePtr res);
  void _make_function(String &class_name, String &function_name,
                      PackedStringArray &function_args, GDExtensionTypePtr res);
  void _open_in_external_editor(Script &script, int line, int column,
                                GDExtensionTypePtr res);
  void _overrides_external_editor(GDExtensionTypePtr res);
  void _complete_code(String &code, String &path, Object &owner,
                      GDExtensionTypePtr res);
  void _lookup_code(String &code, String &symbol, String &path, Object &owner,
                    GDExtensionTypePtr res);
  void _auto_indent_code(String &code, int from_line, int to_line,
                         GDExtensionTypePtr res);
  ...
  void _debug_get_stack_level_locals(int level, int max_subitems, int max_depth,
                                     GDExtensionTypePtr res);
  void _debug_get_stack_level_members(int level, int max_subitems,
                                      int max_depth, GDExtensionTypePtr res);
  void _debug_get_stack_level_instance(int level, GDExtensionTypePtr res);
  void _debug_get_globals(int max_subitems, int max_depth,
                          GDExtensionTypePtr res);
  void _debug_parse_stack_level_expression(int level, String &expression,
                                           int max_subitems, int max_depth,
                                           GDExtensionTypePtr res);
  void _debug_get_current_stack_info(GDExtensionTypePtr res);
  void _reload_all_scripts(GDExtensionTypePtr res);
  void _reload_scripts(GDExtensionTypePtr res, Array &extensions,
                       bool soft_reload);
