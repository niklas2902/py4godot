...
bool theme_has_method() {
  ...
  GDExtensionMethodBindPtr method_bind =
      functions::get_classdb_get_method_bind()(
          &_class_name.godot_owner, &_method_name.godot_owner, 3846893731);
...
PyLanguage *PyLanguage::constructor() {
  ...
  class_->godot_owner =
      functions::get_classdb_construct_object()(&class_name.godot_owner);
  functions::get_object_set_instance()(class_->godot_owner,
                                       &class_name.godot_owner, class_);

  class_->_init_values();
  return class_;
}
void PyLanguage::destroy() {
...
void PyLanguage::_finish(GDExtensionTypePtr res) { print_error("_finish"); }
...
void PyLanguage::_is_control_flow_keyword(String &keyword,
                                          GDExtensionTypePtr res) {
...
void PyLanguage::_make_template(String &template_, String &class_name,
...
void PyLanguage::_get_built_in_templates(StringName &object,
                                         GDExtensionTypePtr res) {
  ...
  String description_val =
      c_string_to_string("This is an example template to show how to start");
...
void PyLanguage::_validate(String &script, String &path,
                           bool validate_functions, bool validate_errors,
                           bool validate_warnings, bool validate_safe_lines,
                           GDExtensionTypePtr res) {
  ...
  bool valid = true;
  GDExtensionVariantPtr value_var = functions::get_dictionary_operator_index()(
      const_cast<GDExtensionTypePtr>(res), &key_var.native_ptr);
  GDExtensionVariantFromTypeConstructorFunc constructor_func_valid =
      functions::get_get_variant_from_type_constructor()(
...
void PyLanguage::_find_function(String &class_name, String &function_name,
                                GDExtensionTypePtr res) {
...
void PyLanguage::_make_function(String &class_name, String &function_name,
                                PackedStringArray &function_args,
                                GDExtensionTypePtr res) {
  ...
  std::string args{};
  for (int i = 0; i < get_packed_string_array_size(function_args.godot_owner);
       i++) {
    godot::String arg_string =
        get_packed_string_array_element(function_args.godot_owner, i);
    char *c_arg_string;
    ...
    std::string komma =
        i == get_packed_string_array_size(function_args.godot_owner) - 1
            ? std::string{}
            : std::string{", "};
  ...
  std::string komma =
      get_packed_string_array_size(function_args.godot_owner) > 0
          ? std::string{", "}
          : std::string{};
  std::string result{"    def " + function_name_string + "(self" + komma +
                     args + "):\n        pass"};
  c_string_to_string_result(result.c_str(), (void **)res);
  free(c_function_name);
}

void PyLanguage::_open_in_external_editor(Script &script, int line, int column,
                                          GDExtensionTypePtr res) {
...
void PyLanguage::_complete_code(String &code, String &path, Object &owner,
                                GDExtensionTypePtr res) {
  print_error("_complete_code");
}

void PyLanguage::_lookup_code(String &code, String &symbol, String &path,
                              Object &owner, GDExtensionTypePtr res) {
  ...
  GDExtensionVariantPtr value_var_type =
      functions::get_dictionary_operator_index()(
          const_cast<GDExtensionTypePtr>(res), &key_type_var.native_ptr);
  GDExtensionVariantFromTypeConstructorFunc constructor_func_type =
      functions::get_get_variant_from_type_constructor()(
          GDExtensionVariantType::GDEXTENSION_VARIANT_TYPE_INT);
  constructor_func_type(value_var_type, &type);
}

void PyLanguage::_auto_indent_code(String &code, int from_line, int to_line,
                                   GDExtensionTypePtr res) {
  print_error("_auto_indent_code");
}

void PyLanguage::_add_global_constant(StringName &name, Variant &value,
                                      GDExtensionTypePtr res) {
  print_error("_add_global_constant");
}

void PyLanguage::_add_named_global_constant(StringName &name, Variant &value,
                                            GDExtensionTypePtr res) {
  print_error("_add_named_global_constant");
}

void PyLanguage::_remove_named_global_constant(StringName &name,
                                               GDExtensionTypePtr res) {
...
void PyLanguage::_debug_get_stack_level_line(int level,
                                             GDExtensionTypePtr res) {
  print_error("_debug_get_stack_level_line");
}

void PyLanguage::_debug_get_stack_level_function(int level,
                                                 GDExtensionTypePtr res) {
  print_error("_debug_get_stack_level_function");
}

void PyLanguage::_debug_get_stack_level_locals(int level, int max_subitems,
                                               int max_depth,
                                               GDExtensionTypePtr res) {
  print_error("_debug_get_stack_level_locals");
}

void PyLanguage::_debug_get_stack_level_members(int level, int max_subitems,
                                                int max_depth,
                                                GDExtensionTypePtr res) {
  print_error("_debug_get_stack_level_members");
}

void PyLanguage::_debug_get_globals(int max_subitems, int max_depth,
                                    GDExtensionTypePtr res) {
  print_error("_debug_get_globals");
}

void PyLanguage::_debug_parse_stack_level_expression(int level,
                                                     String &expression,
                                                     int max_subitems,
                                                     int max_depth,
                                                     GDExtensionTypePtr res) {
...
std::shared_ptr<ScriptExtension> extract_extension(Variant &variant) {
  ...
  GDExtensionVariantType type =
      functions::get_variant_get_type()(&variant.native_ptr);
  auto constructor = functions::get_get_variant_to_type_constructor()(type);
  std::shared_ptr<ScriptExtension> extension =
      std::make_shared<ScriptExtension>();
...
void PyLanguage::_reload_scripts(GDExtensionTypePtr res, Array &extensions,
                                 bool soft_reload) {
  print_error_user("_reload_scripts");
  for (int extension_index = 0; extension_index < extensions.size();
       extension_index++) {
...
void PyLanguage::_reload_tool_script(Script &script, bool soft_reload,
                                     GDExtensionTypePtr res) {}
...
void PyLanguage::_frame(GDExtensionTypePtr res) { print_error("_frame"); }

void PyLanguage::_handles_global_class_type(String &type,
                                            GDExtensionTypePtr res) {
...
void PyLanguage::_get_global_class_name(String &path, GDExtensionTypePtr res) {
  ...
  GDExtensionPtrConstructor constructor =
      functions::get_variant_get_ptr_constructor()(
          GDExtensionVariantType::GDEXTENSION_VARIANT_TYPE_DICTIONARY, 0);
  constructor(res, _args);
}

void PyLanguage::_debug_get_stack_level_instance(int val,
                                                 GDExtensionTypePtr res) {
...
void call_virtual_func__get_name(GDExtensionClassInstancePtr p_instance,
...
void call_virtual_func__init(GDExtensionClassInstancePtr p_instance,
                             const GDExtensionConstTypePtr *p_args,
                             GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__get_type(GDExtensionClassInstancePtr p_instance,
                                 const GDExtensionConstTypePtr *p_args,
                                 GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__get_extension(GDExtensionClassInstancePtr p_instance,
                                      const GDExtensionConstTypePtr *p_args,
                                      GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__finish(GDExtensionClassInstancePtr p_instance,
                               const GDExtensionConstTypePtr *p_args,
                               GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__get_reserved_words(
...
void call_virtual_func__is_control_flow_keyword(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  String args0 = String::new_static(
      *((void **)const_cast<GDExtensionStringPtr>(p_args[0])));
...
void call_virtual_func__get_comment_delimiters(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__get_string_delimiters(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__get_doc_comment_delimiters(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__make_template(GDExtensionClassInstancePtr p_instance,
                                      const GDExtensionConstTypePtr *p_args,
                                      GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  String args0 = String::new_static(
      *((void **)const_cast<GDExtensionStringPtr>(p_args[0])));
  String args1 = String::new_static(
      *((void **)const_cast<GDExtensionStringPtr>(p_args[1])));
  String args2 = String::new_static(
      *((void **)const_cast<GDExtensionStringPtr>(p_args[2])));
...
void call_virtual_func__get_built_in_templates(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  StringName args0 = StringName::new_static(
      *((void **)const_cast<GDExtensionStringPtr>(p_args[0])));
...
void call_virtual_func__is_using_templates(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__validate(GDExtensionClassInstancePtr p_instance,
                                 const GDExtensionConstTypePtr *p_args,
                                 GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  String args0 =
      String::new_static(const_cast<GDExtensionStringPtr *>((p_args + 0)));
  String args1 =
      String::new_static(const_cast<GDExtensionStringPtr *>((p_args + 1)));
...
void call_virtual_func__validate_path(GDExtensionClassInstancePtr p_instance,
                                      const GDExtensionConstTypePtr *p_args,
                                      GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  String args0 =
...
void call_virtual_func__create_script(GDExtensionClassInstancePtr p_instance,
                                      const GDExtensionConstTypePtr *p_args,
                                      GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__has_named_classes(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__supports_builtin_mode(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__supports_documentation(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__can_inherit_from_file(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__can_make_function(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__preferred_file_name_casing(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__find_function(GDExtensionClassInstancePtr p_instance,
                                      const GDExtensionConstTypePtr *p_args,
                                      GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  String args0 =
...
void call_virtual_func__make_function(GDExtensionClassInstancePtr p_instance,
                                      const GDExtensionConstTypePtr *p_args,
                                      GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  String args0 = String::new_static(
  ...
  String args1 = String::new_static(
      *((void **)const_cast<GDExtensionStringPtr>(p_args[1])));
  PackedStringArray args2 =
      PackedStringArray::new_static(const_cast<GDExtensionTypePtr>(p_args[2]));
...
void call_virtual_func__open_in_external_editor(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__overrides_external_editor(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__complete_code(GDExtensionClassInstancePtr p_instance,
                                      const GDExtensionConstTypePtr *p_args,
                                      GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  String args0 =
  ...
  String args1 =
      String::new_static(const_cast<GDExtensionStringPtr *>((p_args + 1)));
  Object args2 =
      Object::new_static(const_cast<GDExtensionObjectPtr *>(p_args + 2));
...
void call_virtual_func__lookup_code(GDExtensionClassInstancePtr p_instance,
                                    const GDExtensionConstTypePtr *p_args,
                                    GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  String args0 =
  ...
  String args1 =
      String::new_static(const_cast<GDExtensionStringPtr *>((p_args + 1)));
  String args2 =
      String::new_static(const_cast<GDExtensionStringPtr *>((p_args + 2)));
  Object args3 =
      Object::new_static(const_cast<GDExtensionTypePtr *>((p_args + 3)));
...
void call_virtual_func__auto_indent_code(GDExtensionClassInstancePtr p_instance,
                                         const GDExtensionConstTypePtr *p_args,
                                         GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  String args0 =
...
void call_virtual_func__add_global_constant(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  StringName args0 =
      StringName::new_static(const_cast<GDExtensionStringPtr *>((p_args + 0)));
  Variant args1 =
      Variant::new_static(const_cast<GDExtensionTypePtr *>((p_args + 1)));
...
void call_virtual_func__add_named_global_constant(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  StringName args0 =
...
void call_virtual_func__remove_named_global_constant(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  StringName args0 =
...
void call_virtual_func__thread_enter(GDExtensionClassInstancePtr p_instance,
                                     const GDExtensionConstTypePtr *p_args,
                                     GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__thread_exit(GDExtensionClassInstancePtr p_instance,
                                    const GDExtensionConstTypePtr *p_args,
                                    GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__debug_get_error(GDExtensionClassInstancePtr p_instance,
                                        const GDExtensionConstTypePtr *p_args,
                                        GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__debug_get_stack_level_count(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__debug_get_stack_level_line(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__debug_get_stack_level_function(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  int args0 = *((int *)(p_args + 0));
...
void call_virtual_func__debug_get_stack_level_locals(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  int args0 = *((int *)(p_args + 0));
...
void call_virtual_func__debug_get_stack_level_members(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  int args0 = *((int *)(p_args + 0));
...
void call_virtual_func__debug_get_stack_level_instance(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  int args0 = *((int *)(p_args + 0));
...
void call_virtual_func__debug_get_globals(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  int args0 = *((int *)(p_args + 0));
...
void call_virtual_func__debug_parse_stack_level_expression(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  int args0 = *((int *)(p_args + 0));
  ...
  pylanguage->_debug_parse_stack_level_expression(args0, args1, args2, args3,
                                                  r_ret);
}

StringName func_name__debug_parse_stack_level_expression;

void call_virtual_func__debug_get_current_stack_info(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__reload_all_scripts(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__reload_scripts(GDExtensionClassInstancePtr p_instance,
                                       const GDExtensionConstTypePtr *p_args,
                                       GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__reload_tool_script(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  Script args0 = *((Script *)(p_args + 0));
...
void call_virtual_func__get_recognized_extensions(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__get_public_functions(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__get_public_constants(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__get_public_annotations(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__profiling_start(GDExtensionClassInstancePtr p_instance,
                                        const GDExtensionConstTypePtr *p_args,
                                        GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__profiling_stop(GDExtensionClassInstancePtr p_instance,
                                       const GDExtensionConstTypePtr *p_args,
                                       GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__frame(GDExtensionClassInstancePtr p_instance,
                              const GDExtensionConstTypePtr *p_args,
                              GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
...
void call_virtual_func__handles_global_class_type(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  String args0 =
...
void call_virtual_func__get_global_class_name(
    GDExtensionClassInstancePtr p_instance,
    const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
  PyLanguage *pylanguage = static_cast<PyLanguage *>(p_instance);
  String args0 =
...
GDExtensionClassCallVirtual get_virtual(void *p_userdata,
                                        GDExtensionConstStringNamePtr p_name) {

  StringName name = StringName::new_static(
      ((void **)const_cast<GDExtensionTypePtr>(p_name))[0]);
  ...
  else if (string_names_equal(func_name__debug_get_stack_level_function,
                              name)) {
  ...
  else if (string_names_equal(func_name__debug_get_stack_level_instance,
                              name)) {
  ...
  else if (string_names_equal(func_name__debug_parse_stack_level_expression,
                              name)) {
...
void deinit_func_names() {
  func_name__get_name.StringName_py_destroy();
  func_name__init.StringName_py_destroy();
  func_name__get_type.StringName_py_destroy();
  func_name__get_extension.StringName_py_destroy();
  func_name__finish.StringName_py_destroy();
  func_name__get_reserved_words.StringName_py_destroy();
  func_name__is_control_flow_keyword.StringName_py_destroy();
  func_name__get_comment_delimiters.StringName_py_destroy();
  func_name__get_doc_comment_delimiters.StringName_py_destroy();
  func_name__get_string_delimiters.StringName_py_destroy();
  func_name__make_template.StringName_py_destroy();
  func_name__get_built_in_templates.StringName_py_destroy();
  func_name__is_using_templates.StringName_py_destroy();
  func_name__validate.StringName_py_destroy();
  func_name__validate_path.StringName_py_destroy();
  func_name__create_script.StringName_py_destroy();
  func_name__has_named_classes.StringName_py_destroy();
  func_name__supports_builtin_mode.StringName_py_destroy();
  func_name__supports_documentation.StringName_py_destroy();
  func_name__can_inherit_from_file.StringName_py_destroy();
  func_name__find_function.StringName_py_destroy();
  func_name__make_function.StringName_py_destroy();
  func_name__can_make_function.StringName_py_destroy();
  func_name__open_in_external_editor.StringName_py_destroy();
  func_name__overrides_external_editor.StringName_py_destroy();
  func_name__preferred_file_name_casing.StringName_py_destroy();
  func_name__complete_code.StringName_py_destroy();
  func_name__lookup_code.StringName_py_destroy();
  func_name__auto_indent_code.StringName_py_destroy();
  func_name__add_global_constant.StringName_py_destroy();
  func_name__add_named_global_constant.StringName_py_destroy();
  func_name__remove_named_global_constant.StringName_py_destroy();
  func_name__thread_enter.StringName_py_destroy();
  func_name__thread_exit.StringName_py_destroy();
  func_name__debug_get_error.StringName_py_destroy();
  func_name__debug_get_stack_level_count.StringName_py_destroy();
  func_name__debug_get_stack_level_line.StringName_py_destroy();
  func_name__debug_get_stack_level_function.StringName_py_destroy();
  func_name__debug_get_stack_level_locals.StringName_py_destroy();
  func_name__debug_get_stack_level_members.StringName_py_destroy();
  func_name__debug_get_stack_level_instance.StringName_py_destroy();
  func_name__debug_get_globals.StringName_py_destroy();
  ...
  func_name__get_public_constants.StringName_py_destroy();
  func_name__get_public_annotations.StringName_py_destroy();
  func_name__profiling_start.StringName_py_destroy();
  func_name__profiling_stop.StringName_py_destroy();
  ...
  func_name__get_extension.shouldBeDeleted = false;
  func_name__finish.shouldBeDeleted = false;
  func_name__get_reserved_words.shouldBeDeleted = false;
  func_name__is_control_flow_keyword.shouldBeDeleted = false;
  func_name__get_comment_delimiters.shouldBeDeleted = false;
  func_name__get_doc_comment_delimiters.shouldBeDeleted = false;
  func_name__get_string_delimiters.shouldBeDeleted = false;
  func_name__make_template.shouldBeDeleted = false;
  func_name__get_built_in_templates.shouldBeDeleted = false;
  func_name__is_using_templates.shouldBeDeleted = false;
  func_name__validate.shouldBeDeleted = false;
  func_name__validate_path.shouldBeDeleted = false;
  func_name__create_script.shouldBeDeleted = false;
  func_name__has_named_classes.shouldBeDeleted = false;
  func_name__supports_builtin_mode.shouldBeDeleted = false;
  func_name__supports_documentation.shouldBeDeleted = false;
  func_name__can_inherit_from_file.shouldBeDeleted = false;
  func_name__find_function.shouldBeDeleted = false;
  func_name__make_function.shouldBeDeleted = false;
  func_name__can_make_function.shouldBeDeleted = false;
  func_name__open_in_external_editor.shouldBeDeleted = false;
  func_name__overrides_external_editor.shouldBeDeleted = false;
  func_name__preferred_file_name_casing.shouldBeDeleted = false;
  func_name__complete_code.shouldBeDeleted = false;
  func_name__lookup_code.shouldBeDeleted = false;
  func_name__auto_indent_code.shouldBeDeleted = false;
  func_name__add_global_constant.shouldBeDeleted = false;
  func_name__add_named_global_constant.shouldBeDeleted = false;
  func_name__remove_named_global_constant.shouldBeDeleted = false;
  func_name__thread_enter.shouldBeDeleted = false;
  func_name__thread_exit.shouldBeDeleted = false;
  func_name__debug_get_error.shouldBeDeleted = false;
  func_name__debug_get_stack_level_count.shouldBeDeleted = false;
  func_name__debug_get_stack_level_line.shouldBeDeleted = false;
  func_name__debug_get_stack_level_function.shouldBeDeleted = false;
  func_name__debug_get_stack_level_locals.shouldBeDeleted = false;
  func_name__debug_get_stack_level_members.shouldBeDeleted = false;
  func_name__debug_get_stack_level_instance.shouldBeDeleted = false;
  func_name__debug_get_globals.shouldBeDeleted = false;
  ...
  func_name__get_public_constants.shouldBeDeleted = false;
  func_name__get_public_annotations.shouldBeDeleted = false;
  func_name__profiling_start.shouldBeDeleted = false;
  func_name__profiling_stop.shouldBeDeleted = false;
...
void init_func_names() {
  ...
  func_name__get_reserved_words =
      c_string_to_string_name("_get_reserved_words");
  func_name__get_reserved_words.shouldBeDeleted = true;
  func_name__is_control_flow_keyword =
      c_string_to_string_name("_is_control_flow_keyword");
  func_name__is_control_flow_keyword.shouldBeDeleted = true;
  func_name__get_comment_delimiters =
      c_string_to_string_name("_get_comment_delimiters");
  func_name__get_comment_delimiters.shouldBeDeleted = true;
  func_name__get_doc_comment_delimiters =
      c_string_to_string_name("_get_doc_comment_delimiters");
  func_name__get_doc_comment_delimiters.shouldBeDeleted = true;
  func_name__get_string_delimiters =
      c_string_to_string_name("_get_string_delimiters");
  ...
  func_name__get_built_in_templates =
      c_string_to_string_name("_get_built_in_templates");
  func_name__get_built_in_templates.shouldBeDeleted = true;
  func_name__is_using_templates =
      c_string_to_string_name("_is_using_templates");
  ...
  func_name__supports_builtin_mode =
      c_string_to_string_name("_supports_builtin_mode");
  func_name__supports_builtin_mode.shouldBeDeleted = true;
  func_name__supports_documentation =
      c_string_to_string_name("_supports_documentation");
  func_name__supports_documentation.shouldBeDeleted = true;
  func_name__can_inherit_from_file =
      c_string_to_string_name("_can_inherit_from_file");
  ...
  func_name__open_in_external_editor =
      c_string_to_string_name("_open_in_external_editor");
  func_name__open_in_external_editor.shouldBeDeleted = true;
  func_name__overrides_external_editor =
      c_string_to_string_name("_overrides_external_editor");
  func_name__overrides_external_editor.shouldBeDeleted = true;
  func_name__preferred_file_name_casing =
      c_string_to_string_name("_preferred_file_name_casing");
  ...
  func_name__add_global_constant =
      c_string_to_string_name("_add_global_constant");
  func_name__add_global_constant.shouldBeDeleted = true;
  func_name__add_named_global_constant =
      c_string_to_string_name("_add_named_global_constant");
  func_name__add_named_global_constant.shouldBeDeleted = true;
  func_name__remove_named_global_constant =
      c_string_to_string_name("_remove_named_global_constant");
  ...
  func_name__debug_get_stack_level_count =
      c_string_to_string_name("_debug_get_stack_level_count");
  func_name__debug_get_stack_level_count.shouldBeDeleted = true;
  func_name__debug_get_stack_level_line =
      c_string_to_string_name("_debug_get_stack_level_line");
  func_name__debug_get_stack_level_line.shouldBeDeleted = true;
  func_name__debug_get_stack_level_function =
      c_string_to_string_name("_debug_get_stack_level_function");
  func_name__debug_get_stack_level_function.shouldBeDeleted = true;
  func_name__debug_get_stack_level_locals =
      c_string_to_string_name("_debug_get_stack_level_locals");
  func_name__debug_get_stack_level_locals.shouldBeDeleted = true;
  func_name__debug_get_stack_level_members =
      c_string_to_string_name("_debug_get_stack_level_members");
  func_name__debug_get_stack_level_members.shouldBeDeleted = true;
  func_name__debug_get_stack_level_instance =
      c_string_to_string_name("_debug_get_stack_level_instance");
  ...
  func_name__debug_parse_stack_level_expression =
      c_string_to_string_name("_debug_parse_stack_level_expression");
  func_name__debug_parse_stack_level_expression.shouldBeDeleted = true;
  func_name__debug_get_current_stack_info =
      c_string_to_string_name("_debug_get_current_stack_info");
  func_name__debug_get_current_stack_info.shouldBeDeleted = true;
  func_name__reload_all_scripts =
      c_string_to_string_name("_reload_all_scripts");
  ...
  func_name__reload_tool_script =
      c_string_to_string_name("_reload_tool_script");
  func_name__reload_tool_script.shouldBeDeleted = true;
  func_name__get_recognized_extensions =
      c_string_to_string_name("_get_recognized_extensions");
  func_name__get_recognized_extensions.shouldBeDeleted = true;
  func_name__get_public_functions =
      c_string_to_string_name("_get_public_functions");
  func_name__get_public_functions.shouldBeDeleted = true;
  func_name__get_public_constants =
      c_string_to_string_name("_get_public_constants");
  func_name__get_public_constants.shouldBeDeleted = true;
  func_name__get_public_annotations =
      c_string_to_string_name("_get_public_annotations");
  ...
  func_name__handles_global_class_type =
      c_string_to_string_name("_handles_global_class_type");
  func_name__handles_global_class_type.shouldBeDeleted = true;
  func_name__get_global_class_name =
      c_string_to_string_name("_get_global_class_name");
...
void register_class() {
  GDExtensionClassCreationInfo *creation_info =
      new GDExtensionClassCreationInfo{};
  init_func_names();
  operator_equal_string_name =
      functions::get_variant_get_ptr_operator_evaluator()(
  ...
  StringName parent_class_name =
      c_string_to_string_name("ScriptLanguageExtension");
  parent_class_name.shouldBeDeleted = true;

  functions::get_classdb_register_extension_class()(
      _library, &class_name_lang.godot_owner, &parent_class_name.godot_owner,
      creation_info);
...
void register_icon(GDExtensionClassInstancePtr instance,
                   const GDExtensionConstVariantPtr *args,
                   GDExtensionVariantPtr return_value, GDExtensionInt arg_count,
