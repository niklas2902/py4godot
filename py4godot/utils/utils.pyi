...
def get_viewport(node: Node) -> py4godot_viewport.Viewport:
    pass

def get_window(node: Node) -> py4godot_window.Window:
    pass

def get_tree(node: Node) -> py4godot_scenetree.SceneTree:
    pass
