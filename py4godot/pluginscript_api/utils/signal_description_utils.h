...
void create_signal_arg(char* name, int variant_type, Array& args_dicts){
    ...
    Variant var_name_arg = Variant::new_static(get_interface()->dictionary_operator_index(&arg_dict.godot_owner, &arg_name_key_variant.native_ptr));
    ...
    Variant var_type_arg = Variant::new_static(get_interface()->dictionary_operator_index(&arg_dict.godot_owner, &arg_type_key_variant.native_ptr));
...
Dictionary init_signal_description(char* name, std::vector<CPPSignalArg> args){
    ...
    Variant var_args = Variant::new_static(get_interface()->dictionary_operator_index(&signal_dict.godot_owner, &arg_key_variant.native_ptr));
