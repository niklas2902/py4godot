...
std::shared_ptr<CPPPropertyDescription>
init_property_description(GDExtensionVariantType type_, StringName &name,
                          StringName &class_name, uint32_t hint,
                          char *hint_string, uint32_t usage) {
  std::shared_ptr<CPPPropertyDescription> res =
