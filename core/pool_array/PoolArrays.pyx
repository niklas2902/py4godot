...
cdef class PoolByteArray:
        def __init__(self, godot_pool_byte_array _native = None):
        if (_native != None):
...
cdef class PoolRealArray:
        def __init__(self, godot_pool_real_array _native = None):
        if (_native != None):
            self._native = _native
        else:
...
cdef class PoolIntArray:
    def __init__(self, godot_pool_int_array _native = None):
        if (_native != None):
            self._native = _native
        else:
...
cdef class PoolStringArray:
    def __init__(self, godot_pool_string_array _native = None):
        if (_native != None):
            self._native = _native
        else:
...
cdef class PoolVector2Array:
    def __init__(self, godot_pool_vector2_array _native = None):
        if (_native != None):
            self._native = _native
        else:
...
cdef class PoolVector3Array:
    def __init__(self, godot_pool_vector3_array _native = None):
        if (_native != None):
            self._native = _native
        else:
...
cdef class PoolColorArray:
        def __init__(self, godot_pool_color_array _native = None):
        if (_native != None):
            self._native = _native
        else:
