...
cdef class AABB:
    ...
    def __init__(self, godot_aabb _native = None, Vector3 v, Vector3 v2):
        if (_native != None):
    ...
    def get_position(self):
        pass
        #return Vector3(api_core.godot_aabb_get_position(&self._native))
    ...
    def get_size(self):
        pass
        #return Vector3(api_core.godot_aabb_get_size(&self._native))
    ...
    def merge(self, AABB with_):
        return AABB(api_core.godot_aabb_merge(&self._native, &with_._native))

    def intersection(self, AABB with_):
        return AABB(api_core.godot_aabb_intersection(&self._native, &with_._native))

    def intersects_plane(self, Plane plane):
        return Plane(api_core.godot_aabb_intersects_plane(&self._native, &plane._native))
    ...
    def get_support(self, Vector3 dir):
        return Vector3(api_core.godot_aabb_get_support(&self._native, *dir._native))

    def get_longest_axis(self):
        return Vector3(api_core.godot_aabb_get_longest_axis(&self._native))
    ...
    def get_shortest_axis(self):
        return Vector3(api_core.godot_aabb_get_shortest_axis(&self._native))
    ...
    def get_shortest_axis_size(self):
        return AABB(api_core.godot_aabb_get_shortest_axis_size(&self._native))
    ...
    def grow(self, godot_real by):
        return AABB(api_core.godot_aabb_expand(&self._native, &by))

    def get_endpoint(self,  godot_int index):
        return Vector3(godot_aabb_get_endpoint(&self._native, &index))
